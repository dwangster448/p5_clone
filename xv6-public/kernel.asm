...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 4f 83 10 80 	movl   $0x8010834f,(%esp)
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 17 6a 00 00       	call   80107550 <setupkvm>
...
80100ba3:	e8 c8 67 00 00       	call   80107370 <allocuvm>
...
80100bd9:	e8 a2 66 00 00       	call   80107280 <loaduvm>
...
80100c1b:	e8 b0 68 00 00       	call   801074d0 <freevm>
  if(ip){
...
80100c62:	e8 09 67 00 00       	call   80107370 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 68 69 00 00       	call   801075f0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 c3 6a 00 00       	call   801077c0 <copyout>
...
80100d11:	e8 ba 67 00 00       	call   801074d0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 58 6a 00 00       	call   801077c0 <copyout>
...
80100dcd:	e8 1e 63 00 00       	call   801070f0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 f6 66 00 00       	call   801074d0 <freevm>
  return 0;
...
80101325:	e8 86 33 00 00       	call   801046b0 <memset>
  log_write(bp);
...
801013d7:	e8 b4 31 00 00       	call   80104590 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 86 31 00 00       	call   80104590 <release>
      return ip;
...
80101541:	e8 0a 32 00 00       	call   80104750 <memmove>
  brelse(bp);
...
80101576:	e8 a5 2e 00 00       	call   80104420 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 5c 2d 00 00       	call   801042f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 8f 31 00 00       	call   80104750 <memmove>
  brelse(bp);
...
8010168e:	e8 1d 30 00 00       	call   801046b0 <memset>
      dip->type = type;
...
80101731:	e8 1a 30 00 00       	call   80104750 <memmove>
  log_write(bp);
...
8010175f:	e8 8c 2e 00 00       	call   801045f0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 1c 2e 00 00       	call   80104590 <release>
}
...
801017a2:	e8 89 2b 00 00       	call   80104330 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 33 2f 00 00       	call   80104750 <memmove>
    brelse(bp);
...
80101873:	e8 58 2b 00 00       	call   801043d0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 fc 2a 00 00       	jmp    80104390 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 6b 2a 00 00       	call   80104330 <acquiresleep>
...
801018da:	e8 b1 2a 00 00       	call   80104390 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 05 2d 00 00       	call   801045f0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 8b 2c 00 00       	jmp    80104590 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 db 2c 00 00       	call   801045f0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 6c 2c 00 00       	call   80104590 <release>
    if(r == 1){
...
80101a23:	e8 a8 29 00 00       	call   801043d0 <holdingsleep>
...
80101b37:	e8 14 2c 00 00       	call   80104750 <memmove>
    brelse(bp);
...
80101c33:	e8 18 2b 00 00       	call   80104750 <memmove>
    log_write(bp);
...
80101cce:	e8 ed 2a 00 00       	call   801047c0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 8e 2a 00 00       	call   801047c0 <strncmp>
      continue;
...
80101dba:	e8 31 28 00 00       	call   801045f0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 c1 27 00 00       	call   80104590 <release>
...
80101e27:	e8 24 29 00 00       	call   80104750 <memmove>
...
80101edb:	e8 70 28 00 00       	call   80104750 <memmove>
    name[len] = 0;
...
80101f2b:	e8 a0 24 00 00       	call   801043d0 <holdingsleep>
...
80101f4a:	e8 41 24 00 00       	call   80104390 <releasesleep>
  iput(ip);
...
80101f6d:	e8 5e 24 00 00       	call   801043d0 <holdingsleep>
...
80101f90:	e8 3b 24 00 00       	call   801043d0 <holdingsleep>
...
80101fa7:	e8 e4 23 00 00       	call   80104390 <releasesleep>
}
...
8010203d:	e8 ce 27 00 00       	call   80104810 <strncpy>
...
80102088:	68 ee 7f 10 80       	push   $0x80107fee
...
801021d0:	e8 4b 22 00 00       	call   80104420 <initlock>
...
8010224e:	e8 9d 23 00 00       	call   801045f0 <acquire>
...
801022cb:	e8 c0 22 00 00       	call   80104590 <release>
...
801022ee:	e8 dd 20 00 00       	call   801043d0 <holdingsleep>
...
80102328:	e8 c3 22 00 00       	call   801045f0 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 05 22 00 00       	jmp    80104590 <release>
...
801024f2:	e8 b9 21 00 00       	call   801046b0 <memset>
...
80102528:	e8 c3 20 00 00       	call   801045f0 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 48 20 00 00       	jmp    80104590 <release>
    panic("kfree");
...
80102625:	e8 f6 1d 00 00       	call   80104420 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 38 1f 00 00       	call   801045f0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 aa 1e 00 00       	call   80104590 <release>
  return (char*)r;
...
80102af7:	e8 04 1c 00 00       	call   80104700 <memcmp>
...
80102c24:	e8 27 1b 00 00       	call   80104750 <memmove>
...
80102cd4:	e8 47 17 00 00       	call   80104420 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 80 18 00 00       	call   801045f0 <acquire>
...
80102dbc:	e8 cf 17 00 00       	call   80104590 <release>
      break;
    }
  }
}
...
80102dde:	e8 0d 18 00 00       	call   801045f0 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 6f 17 00 00       	call   80104590 <release>
}
...
80102e36:	e8 b5 17 00 00       	call   801045f0 <acquire>
    wakeup(&log);
...
80102e58:	e8 33 17 00 00       	call   80104590 <release>
...
80102eb4:	e8 97 18 00 00       	call   80104750 <memmove>
...
80102f14:	e8 77 16 00 00       	call   80104590 <release>
...
80102f76:	e8 75 16 00 00       	call   801045f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 d6 15 00 00       	jmp    80104590 <release>
...
80103022:	e8 59 2d 00 00       	call   80105d80 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 95 40 00 00       	call   801070e0 <switchkvm>
  seginit();
8010304b:	e8 80 3e 00 00       	call   80106ed0 <seginit>
  lapicinit();
...
80103081:	e8 4a 45 00 00       	call   801075d0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 3b 3e 00 00       	call   80106ed0 <seginit>
  picinit();       // disable pic
...
801030a9:	e8 72 08 00 00       	call   80103920 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 4d 2c 00 00       	call   80105d00 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 77 16 00 00       	call   80104750 <memmove>
...
801031c4:	e8 37 15 00 00       	call   80104700 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 7c 14 00 00       	call   80104700 <memcmp>
...
801033c8:	e8 33 13 00 00       	call   80104700 <memcmp>
...
8010353f:	e8 ac 10 00 00       	call   801045f0 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 07 10 00 00       	jmp    80104590 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 f7 0f 00 00       	call   80104590 <release>
    kfree((char*)p);
...
801035dd:	e8 0e 10 00 00       	call   801045f0 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 1f 0f 00 00       	call   80104590 <release>
        return -1;
...
801036c2:	e8 c9 0e 00 00       	call   80104590 <release>
  return n;
...
801036e6:	e8 05 0f 00 00       	call   801045f0 <acquire>
...
8010377e:	e8 0d 0e 00 00       	call   80104590 <release>
  return i;
...
80103799:	e8 f2 0d 00 00       	call   80104590 <release>
      return -1;
...
801037c1:	e8 2a 0e 00 00       	call   801045f0 <acquire>
801037c6:	83 c4 10             	add    $0x10,%esp
801037c9:	eb 17                	jmp    801037e2 <allocproc+0x32>
801037cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 c4 02 00 00    	add    $0x2c4,%ebx
...
80103803:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103809:	e8 82 0d 00 00       	call   80104590 <release>
...
8010381b:	0f 84 90 00 00 00    	je     801038b1 <allocproc+0x101>
    return 0;
  }
...
8010382f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 e9 5c 10 80 	movl   $0x80105ce9,0x14(%eax)
  p->context = (struct context*)sp;
...
80103841:	e8 6a 0e 00 00       	call   801046b0 <memset>
  p->context->eip = (uint)forkret;
80103846:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103849:	8d 93 40 02 00 00    	lea    0x240(%ebx),%edx
8010384f:	83 c4 10             	add    $0x10,%esp
80103852:	c7 40 10 d0 38 10 80 	movl   $0x801038d0,0x10(%eax)


  p->total_mmaps = 0;
80103859:	8d 83 00 02 00 00    	lea    0x200(%ebx),%eax
8010385f:	c7 83 c0 02 00 00 00 	movl   $0x0,0x2c0(%ebx)
80103866:	00 00 00 
...
80103879:	c7 40 3c ff ff ff ff 	movl   $0xffffffff,0x3c(%eax)
    p->wmap.n_loaded_pages[i] = -1;         // Invalid page count
80103880:	c7 40 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%eax)
  for (int i = 0; i < MAX_WMAP_INFO; i++) {
80103887:	39 d0                	cmp    %edx,%eax
80103889:	75 e5                	jne    80103870 <allocproc+0xc0>
  }
...
801038a2:	e8 e9 0c 00 00       	call   80104590 <release>
}
...
80103926:	68 e0 7d 10 80       	push   $0x80107de0
...
801039fc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039fe:	a3 5c de 11 80       	mov    %eax,0x8011de5c
  if((p->pgdir = setupkvm()) == 0)
80103a03:	e8 48 3b 00 00       	call   80107550 <setupkvm>
...
80103a21:	e8 da 37 00 00       	call   80107200 <inituvm>
...
80103a8f:	68 10 7e 10 80       	push   $0x80107e10
80103a94:	50                   	push   %eax
80103a95:	e8 d6 0d 00 00       	call   80104870 <safestrcpy>
  p->cwd = namei("/");
80103a9a:	c7 04 24 19 7e 10 80 	movl   $0x80107e19,(%esp)
...
80103ad3:	68 f7 7d 10 80       	push   $0x80107df7
...
80103b0b:	e8 e0 35 00 00       	call   801070f0 <switchuvm>
  return 0;
...
80103b2a:	e8 41 38 00 00       	call   80107370 <allocuvm>
...
80103b4a:	e8 51 39 00 00       	call   801074a0 <deallocuvm>
...
80103b98:	e8 a3 3a 00 00       	call   80107640 <copyuvm>
...
80103ca1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca4:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
...
80103cd0:	e8 1b 34 00 00       	call   801070f0 <switchuvm>
...
80103ce2:	e8 e4 0b 00 00       	call   801048cb <swtch>
      switchkvm();
80103ce7:	e8 f4 33 00 00       	call   801070e0 <switchkvm>
      c->proc = 0;
80103cec:	83 c4 10             	add    $0x10,%esp
80103cef:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cf6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cf9:	81 c3 c4 02 00 00    	add    $0x2c4,%ebx
80103cff:	81 fb 54 de 11 80    	cmp    $0x8011de54,%ebx
80103d05:	75 b9                	jne    80103cc0 <scheduler+0x40>
    release(&ptable.lock);
80103d07:	83 ec 0c             	sub    $0xc,%esp
80103d0a:	68 20 2d 11 80       	push   $0x80112d20
80103d0f:	e8 7c 08 00 00       	call   80104590 <release>
    sti();
...
80103de9:	e8 d2 fb ff ff       	call   801039c0 <myproc>
  if(curproc == initproc)
80103dee:	39 05 5c de 11 80    	cmp    %eax,0x8011de5c
...
80103e60:	05 c4 02 00 00       	add    $0x2c4,%eax
80103e65:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
...
80103e77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e7e:	05 c4 02 00 00       	add    $0x2c4,%eax
80103e83:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
80103e88:	75 e2                	jne    80103e6c <exit+0x8c>
      p->parent = initproc;
80103e8a:	8b 0d 5c de 11 80    	mov    0x8011de5c,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103ea0:	81 c2 c4 02 00 00    	add    $0x2c4,%edx
80103ea6:	81 fa 54 de 11 80    	cmp    $0x8011de54,%edx
...
80103ec7:	90                   	nop
80103ec8:	05 c4 02 00 00       	add    $0x2c4,%eax
80103ecd:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
...
80103f47:	90                   	nop
80103f48:	81 c3 c4 02 00 00    	add    $0x2c4,%ebx
80103f4e:	81 fb 54 de 11 80    	cmp    $0x8011de54,%ebx
...
80103f5f:	74 5f                	je     80103fc0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f61:	81 c3 c4 02 00 00    	add    $0x2c4,%ebx
      havekids = 1;
80103f67:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f6c:	81 fb 54 de 11 80    	cmp    $0x8011de54,%ebx
...
80103f81:	0f 85 8f 00 00 00    	jne    80104016 <wait+0x106>
  pushcli();
80103f87:	e8 14 05 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103f8c:	e8 af f9 ff ff       	call   80103940 <mycpu>
  p = c->proc;
80103f91:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f97:	e8 54 05 00 00       	call   801044f0 <popcli>
  if(p == 0)
...
80103fd9:	e8 f2 34 00 00       	call   801074d0 <freevm>
        p->pid = 0;
...
80104170:	05 c4 02 00 00       	add    $0x2c4,%eax
80104175:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
...
80104187:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010418e:	05 c4 02 00 00       	add    $0x2c4,%eax
80104193:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
...
801041a4:	c9                   	leave  
  release(&ptable.lock);
801041a5:	e9 e6 03 00 00       	jmp    80104590 <release>
...
801041d0:	05 c4 02 00 00       	add    $0x2c4,%eax
801041d5:	3d 54 de 11 80       	cmp    $0x8011de54,%eax
...
801041fd:	e8 8e 03 00 00       	call   80104590 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010424b:	68 4f 83 10 80       	push   $0x8010834f
80104250:	e8 4b c4 ff ff       	call   801006a0 <cprintf>
80104255:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104258:	81 c3 c4 02 00 00    	add    $0x2c4,%ebx
8010425e:	81 fb c0 de 11 80    	cmp    $0x8011dec0,%ebx
...
8010427b:	8b 14 85 ec 7e 10 80 	mov    -0x7fef8114(,%eax,4),%edx
      state = "???";
...
801042b8:	e8 83 01 00 00       	call   80104440 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042fa:	68 04 7f 10 80       	push   $0x80107f04
...
80104535:	68 0f 7f 10 80       	push   $0x80107f0f
8010453a:	e8 41 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010453f:	83 ec 0c             	sub    $0xc,%esp
80104542:	68 26 7f 10 80       	push   $0x80107f26
...
801045ab:	68 2d 7f 10 80       	push   $0x80107f2d
...
801046a0:	68 35 7f 10 80       	push   $0x80107f35
...
80104ac7:	83 fa 18             	cmp    $0x18,%edx
80104aca:	77 24                	ja     80104af0 <syscall+0x40>
80104acc:	8b 14 85 60 7f 10 80 	mov    -0x7fef80a0(,%eax,4),%edx
...
80104af8:	68 3d 7f 10 80       	push   $0x80107f3d
...
80104b37:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b3a:	e8 81 d5 ff ff       	call   801020c0 <nameiparent>
...
80104b50:	e8 2b cc ff ff       	call   80101780 <ilock>
...
80104b5c:	e8 7f d1 ff ff       	call   80101ce0 <dirlookup>
...
80104b6e:	e8 9d ce ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104b73:	89 34 24             	mov    %esi,(%esp)
80104b76:	e8 05 cc ff ff       	call   80101780 <ilock>
...
80104ba4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ba6:	e8 65 ce ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104bca:	e8 41 ca ff ff       	call   80101610 <ialloc>
...
80104c01:	e8 ca ca ff ff       	call   801016d0 <iupdate>
...
80104c18:	e8 c3 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c28:	e8 e3 cd ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104c49:	e8 82 ca ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c4e:	83 c4 0c             	add    $0xc,%esp
80104c51:	ff 76 04             	push   0x4(%esi)
80104c54:	68 e4 7f 10 80       	push   $0x80107fe4
80104c59:	56                   	push   %esi
80104c5a:	e8 81 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c6c:	68 e3 7f 10 80       	push   $0x80107fe3
80104c71:	56                   	push   %esi
80104c72:	e8 69 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c81:	68 d7 7f 10 80       	push   $0x80107fd7
...
80104c9f:	68 e6 7f 10 80       	push   $0x80107fe6
80104ca4:	e8 d7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ca9:	83 ec 0c             	sub    $0xc,%esp
80104cac:	68 c8 7f 10 80       	push   $0x80107fc8
...
80104d44:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80104d45:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
...
80104d58:	78 5e                	js     80104db8 <sys_read+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d5a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d5e:	77 58                	ja     80104db8 <sys_read+0x78>
...
80104d6e:	74 48                	je     80104db8 <sys_read+0x78>
...
80104d83:	78 33                	js     80104db8 <sys_read+0x78>
...
80104d98:	78 1e                	js     80104db8 <sys_read+0x78>
...
80104dac:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104daf:	5b                   	pop    %ebx
80104db0:	5e                   	pop    %esi
80104db1:	5d                   	pop    %ebp
80104db2:	c3                   	ret    
...
80104dbd:	eb ed                	jmp    80104dac <sys_read+0x6c>
80104dbf:	90                   	nop
...
80104dce:	e8 9d fb ff ff       	call   80104970 <argint>
...
80104de0:	e8 db eb ff ff       	call   801039c0 <myproc>
...
80104df9:	e8 72 fb ff ff       	call   80104970 <argint>
...
80104e0e:	e8 ad fb ff ff       	call   801049c0 <argptr>
...
80104e4e:	e8 1d fb ff ff       	call   80104970 <argint>
...
80104e60:	e8 5b eb ff ff       	call   801039c0 <myproc>
...
80104e71:	74 25                	je     80104e98 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e73:	e8 48 eb ff ff       	call   801039c0 <myproc>
  fileclose(f);
...
80104eae:	e8 bd fa ff ff       	call   80104970 <argint>
...
80104ec0:	e8 fb ea ff ff       	call   801039c0 <myproc>
...
80104ed8:	e8 e3 fa ff ff       	call   801049c0 <argptr>
...
80104f1f:	e8 0c fb ff ff       	call   80104a30 <argstr>
...
80104f38:	e8 f3 fa ff ff       	call   80104a30 <argstr>
...
801050ad:	58                   	pop    %eax
801050ae:	5a                   	pop    %edx
801050af:	68 e4 7f 10 80       	push   $0x80107fe4
...
801050c8:	68 e3 7f 10 80       	push   $0x80107fe3
...
80105268:	e8 03 f7 ff ff       	call   80104970 <argint>
...
801052b7:	74 23                	je     801052dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801052b9:	e8 02 e7 ff ff       	call   801039c0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105307:	e8 14 f8 ff ff       	call   80104b20 <create>
    if(ip == 0){
...
80105394:	e8 97 f6 ff ff       	call   80104a30 <argstr>
...
801053af:	e8 6c f7 ff ff       	call   80104b20 <create>
...
801053f4:	e8 37 f6 ff ff       	call   80104a30 <argstr>
...
80105409:	e8 62 f5 ff ff       	call   80104970 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010541e:	e8 4d f5 ff ff       	call   80104970 <argint>
     argint(1, &major) < 0 ||
...
8010543e:	e8 dd f6 ff ff       	call   80104b20 <create>
     argint(2, &minor) < 0 ||
...
80105475:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105478:	e8 43 e5 ff ff       	call   801039c0 <myproc>
...
8010548d:	e8 9e f5 ff ff       	call   80104a30 <argstr>
...
80105535:	e8 f6 f4 ff ff       	call   80104a30 <argstr>
...
80105551:	e8 1a f4 ff ff       	call   80104970 <argint>
...
80105570:	e8 3b f1 ff ff       	call   801046b0 <memset>
...
8010559a:	e8 41 f3 ff ff       	call   801048e0 <fetchint>
...
801055b8:	e8 63 f3 ff ff       	call   80104920 <fetchstr>
...
80105647:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105649:	e8 72 e3 ff ff       	call   801039c0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105687:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010568a:	e8 31 e3 ff ff       	call   801039c0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056a6:	75 f0                	jne    80105698 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801056a8:	e8 13 e3 ff ff       	call   801039c0 <myproc>
...
{
  return fork();
801056e0:	e9 7b e4 ff ff       	jmp    80103b60 <fork>
...
801056f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056f6:	e8 e5 e6 ff ff       	call   80103de0 <exit>
...
8010571c:	e8 4f f2 ff ff       	call   80104970 <argint>
...
8010572e:	e8 7d ea ff ff       	call   801041b0 <kill>
...
80105753:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105756:	e8 65 e2 ff ff       	call   801039c0 <myproc>
...
8010576d:	e8 fe f1 ff ff       	call   80104970 <argint>
...
80105786:	e8 55 e3 ff ff       	call   80103ae0 <growproc>
...
801057bd:	e8 ae f1 ff ff       	call   80104970 <argint>
...
801057d0:	68 80 de 11 80       	push   $0x8011de80
801057d5:	e8 16 ee ff ff       	call   801045f0 <acquire>
  ticks0 = ticks;
  while (ticks - ticks0 < n)
801057da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057dd:	8b 1d 60 de 11 80    	mov    0x8011de60,%ebx
  while (ticks - ticks0 < n)
...
801057f3:	68 80 de 11 80       	push   $0x8011de80
801057f8:	68 60 de 11 80       	push   $0x8011de60
801057fd:	e8 8e e8 ff ff       	call   80104090 <sleep>
  while (ticks - ticks0 < n)
80105802:	a1 60 de 11 80       	mov    0x8011de60,%eax
...
8010580f:	73 2f                	jae    80105840 <sys_sleep+0x90>
    if (myproc()->killed)
80105811:	e8 aa e1 ff ff       	call   801039c0 <myproc>
...
80105820:	68 80 de 11 80       	push   $0x8011de80
...
80105843:	68 80 de 11 80       	push   $0x8011de80
...
80105864:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105867:	68 80 de 11 80       	push   $0x8011de80
8010586c:	e8 7f ed ff ff       	call   801045f0 <acquire>
  xticks = ticks;
80105871:	8b 1d 60 de 11 80    	mov    0x8011de60,%ebx
  release(&tickslock);
80105877:	c7 04 24 80 de 11 80 	movl   $0x8011de80,(%esp)
...
8010589d:	e8 ce f0 ff ff       	call   80104970 <argint>
...
801058ae:	78 2c                	js     801058dc <va2pa+0x4c>
  {
    return FAILED; // Failed fetching value to integer
  }

  uint pt_index = va & 0xFFFFF000;
801058b0:	8b 5d f4             	mov    -0xc(%ebp),%ebx

  uint offset = va & 0x00000FFF;

  pte_t *pte = walkpgdir(myproc()->pgdir, (void *)pt_index, 0); // TODO check pde_t pte_t type check
801058b3:	e8 08 e1 ff ff       	call   801039c0 <myproc>
801058b8:	83 ec 04             	sub    $0x4,%esp
  uint pt_index = va & 0xFFFFF000;
801058bb:	89 da                	mov    %ebx,%edx
  pte_t *pte = walkpgdir(myproc()->pgdir, (void *)pt_index, 0); // TODO check pde_t pte_t type check
801058bd:	6a 00                	push   $0x0
  uint pt_index = va & 0xFFFFF000;
801058bf:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  pte_t *pte = walkpgdir(myproc()->pgdir, (void *)pt_index, 0); // TODO check pde_t pte_t type check
801058c5:	52                   	push   %edx
801058c6:	ff 70 04             	push   0x4(%eax)
801058c9:	e8 92 16 00 00       	call   80106f60 <walkpgdir>
...
801058d5:	25 ff 0f 00 00       	and    $0xfff,%eax
  uint physical_address = *pte + offset;
801058da:	03 02                	add    (%edx),%eax
}
801058dc:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801058df:	c9                   	leave  
801058e0:	c3                   	ret    
...
8010591d:	e8 9e e0 ff ff       	call   801039c0 <myproc>
80105922:	89 c3                	mov    %eax,%ebx

  if (p == 0)
80105924:	85 c0                	test   %eax,%eax
80105926:	74 65                	je     8010598d <getwmapinfo+0x8d>
  }
...
80105928:	8b 75 e4             	mov    -0x1c(%ebp),%esi
8010592b:	8d 40 7c             	lea    0x7c(%eax),%eax
8010592e:	8d 8b fc 01 00 00    	lea    0x1fc(%ebx),%ecx
80105934:	8d 56 04             	lea    0x4(%esi),%edx
80105937:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010593e:	66 90                	xchg   %ax,%ax
    if (p->mmap[i].used) // If the mmap entry is used
80105940:	8b 78 0c             	mov    0xc(%eax),%edi
80105943:	85 ff                	test   %edi,%edi
80105945:	74 13                	je     8010595a <getwmapinfo+0x5a>
      info->addr[i] = p->mmap[i].addr;                     // Copy the starting address
80105947:	8b 38                	mov    (%eax),%edi
80105949:	89 3a                	mov    %edi,(%edx)
      info->length[i] = p->mmap[i].length;                 // Copy the length
8010594b:	8b 78 04             	mov    0x4(%eax),%edi
8010594e:	89 7a 40             	mov    %edi,0x40(%edx)
      info->n_loaded_pages[i] = p->mmap[i].n_loaded_pages; // Number of pages loaded into memory
80105951:	8b 78 14             	mov    0x14(%eax),%edi
80105954:	89 ba 80 00 00 00    	mov    %edi,0x80(%edx)
  for (int i = 0; i < MAX_WMMAP_INFO; i++)
8010595a:	83 c0 18             	add    $0x18,%eax
8010595d:	83 c2 04             	add    $0x4,%edx
80105960:	39 c8                	cmp    %ecx,%eax
80105962:	75 dc                	jne    80105940 <getwmapinfo+0x40>
    }

  info->total_mmaps = p->total_mmaps;
80105964:	8b 83 c0 02 00 00    	mov    0x2c0(%ebx),%eax
...
801059a4:	8b 7d 0c             	mov    0xc(%ebp),%edi
{
801059a7:	8b 45 08             	mov    0x8(%ebp),%eax
801059aa:	56                   	push   %esi
801059ab:	53                   	push   %ebx
  for (uint addr = start_addr; addr + length <= end_addr; addr += PGSIZE)
801059ac:	8d 9f 00 00 00 60    	lea    0x60000000(%edi),%ebx
801059b2:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
801059b8:	77 5a                	ja     80105a14 <find_free_mmap_space+0x74>
801059ba:	be 00 00 00 60       	mov    $0x60000000,%esi
801059bf:	8d 78 7c             	lea    0x7c(%eax),%edi
801059c2:	8d 88 fc 01 00 00    	lea    0x1fc(%eax),%ecx
801059c8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801059cf:	90                   	nop
801059d0:	89 f8                	mov    %edi,%eax
801059d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    for (int i = 0; i < MAX_MMAPS; i++)
    {
      ...
      if (mmap->used &&
801059d8:	8b 50 0c             	mov    0xc(%eax),%edx
801059db:	85 d2                	test   %edx,%edx
801059dd:	74 0d                	je     801059ec <find_free_mmap_space+0x4c>
          !(addr + length <= mmap->addr || addr >= mmap->addr + mmap->length)) // If overlap exists
801059df:	8b 10                	mov    (%eax),%edx
      if (mmap->used &&
801059e1:	39 da                	cmp    %ebx,%edx
801059e3:	73 07                	jae    801059ec <find_free_mmap_space+0x4c>
          !(addr + length <= mmap->addr || addr >= mmap->addr + mmap->length)) // If overlap exists
801059e5:	03 50 04             	add    0x4(%eax),%edx
801059e8:	39 f2                	cmp    %esi,%edx
801059ea:	77 14                	ja     80105a00 <find_free_mmap_space+0x60>
    for (int i = 0; i < MAX_MMAPS; i++)
801059ec:	83 c0 18             	add    $0x18,%eax
801059ef:	39 c8                	cmp    %ecx,%eax
801059f1:	75 e5                	jne    801059d8 <find_free_mmap_space+0x38>
      return addr;
    }
  }
...
801059fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for (uint addr = start_addr; addr + length <= end_addr; addr += PGSIZE)
80105a00:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105a06:	81 c6 00 10 00 00    	add    $0x1000,%esi
80105a0c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80105a12:	76 bc                	jbe    801059d0 <find_free_mmap_space+0x30>
  return 0; // No suitable address found
80105a14:	31 f6                	xor    %esi,%esi
}
80105a16:	5b                   	pop    %ebx
80105a17:	89 f0                	mov    %esi,%eax
80105a19:	5e                   	pop    %esi
80105a1a:	5f                   	pop    %edi
80105a1b:	5d                   	pop    %ebp
80105a1c:	c3                   	ret    
...
80105a29:	8b 95 cc 02 00 00    	mov    0x2cc(%ebp),%edx
80105a2f:	56                   	push   %esi
80105a30:	53                   	push   %ebx
  if (addr == 0 || addr % PGSIZE != 0)
80105a31:	81 fa ff ff ff 5f    	cmp    $0x5fffffff,%edx
80105a37:	76 08                	jbe    80105a41 <check_fixed+0x21>
  }

  // Ensure addr is within valid bounds
  if (addr < 0x60000000 || addr + length > 0x80000000)
80105a39:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
80105a3f:	74 0f                	je     80105a50 <check_fixed+0x30>
      }
    }
  }
...
80105a4d:	8d 76 00             	lea    0x0(%esi),%esi
  if (addr < 0x60000000 || addr + length > 0x80000000)
80105a50:	8b bd d0 02 00 00    	mov    0x2d0(%ebp),%edi
80105a56:	01 d7                	add    %edx,%edi
80105a58:	81 ff 00 00 00 80    	cmp    $0x80000000,%edi
80105a5e:	77 e1                	ja     80105a41 <check_fixed+0x21>
80105a60:	8d 85 84 00 00 00    	lea    0x84(%ebp),%eax
80105a66:	8d 9d 04 02 00 00    	lea    0x204(%ebp),%ebx
80105a6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (mmap->used)
80105a70:	8b 48 0c             	mov    0xc(%eax),%ecx
80105a73:	85 c9                	test   %ecx,%ecx
80105a75:	74 0f                	je     80105a86 <check_fixed+0x66>
      if (addr < mmap->addr + mmap->length && addr + length > mmap->addr)
80105a77:	8b 08                	mov    (%eax),%ecx
80105a79:	8b 70 04             	mov    0x4(%eax),%esi
80105a7c:	01 ce                	add    %ecx,%esi
80105a7e:	39 d6                	cmp    %edx,%esi
80105a80:	76 04                	jbe    80105a86 <check_fixed+0x66>
80105a82:	39 cf                	cmp    %ecx,%edi
80105a84:	77 1a                	ja     80105aa0 <check_fixed+0x80>
  for (int i = 0; i < MAX_MMAPS; i++)
80105a86:	83 c0 18             	add    $0x18,%eax
80105a89:	39 c3                	cmp    %eax,%ebx
80105a8b:	75 e3                	jne    80105a70 <check_fixed+0x50>
}
80105a8d:	5b                   	pop    %ebx
  return 1; // No overlap
80105a8e:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105a93:	5e                   	pop    %esi
80105a94:	5f                   	pop    %edi
80105a95:	5d                   	pop    %ebp
...
80105ab9:	8b 55 0c             	mov    0xc(%ebp),%edx
80105abc:	8b 7d 08             	mov    0x8(%ebp),%edi
80105abf:	8b 5d 10             	mov    0x10(%ebp),%ebx
  // Validate addr and check for overlap first
  if (addr % PGSIZE != 0 || addr < 0x60000000 || addr + length > 0x80000000)
80105ac2:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
80105ac8:	75 5c                	jne    80105b26 <suggestive_address+0x76>
80105aca:	81 fa ff ff ff 5f    	cmp    $0x5fffffff,%edx
80105ad0:	76 54                	jbe    80105b26 <suggestive_address+0x76>
80105ad2:	8d 04 13             	lea    (%ebx,%edx,1),%eax
80105ad5:	89 c6                	mov    %eax,%esi
80105ad7:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80105adc:	77 48                	ja     80105b26 <suggestive_address+0x76>
80105ade:	8d 8f fc 01 00 00    	lea    0x1fc(%edi),%ecx
80105ae4:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80105ae7:	8d 47 7c             	lea    0x7c(%edi),%eax
80105aea:	89 5d e0             	mov    %ebx,-0x20(%ebp)
80105aed:	89 cf                	mov    %ecx,%edi
80105aef:	89 f3                	mov    %esi,%ebx
80105af1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  for (int i = 0; i < MAX_MMAPS; i++)
  {
    struct mmap_region *mmap = &p->mmap[i];
    if (mmap->used &&
80105af8:	8b 48 0c             	mov    0xc(%eax),%ecx
80105afb:	85 c9                	test   %ecx,%ecx
80105afd:	74 0f                	je     80105b0e <suggestive_address+0x5e>
        (addr < mmap->addr + mmap->length && addr + length > mmap->addr)) // Overlap detected
80105aff:	8b 08                	mov    (%eax),%ecx
80105b01:	8b 70 04             	mov    0x4(%eax),%esi
80105b04:	01 ce                	add    %ecx,%esi
80105b06:	39 d6                	cmp    %edx,%esi
80105b08:	76 04                	jbe    80105b0e <suggestive_address+0x5e>
80105b0a:	39 cb                	cmp    %ecx,%ebx
80105b0c:	77 12                	ja     80105b20 <suggestive_address+0x70>
  for (int i = 0; i < MAX_MMAPS; i++)
80105b0e:	83 c0 18             	add    $0x18,%eax
80105b11:	39 f8                	cmp    %edi,%eax
80105b13:	75 e3                	jne    80105af8 <suggestive_address+0x48>
...
80105b15:	83 c4 1c             	add    $0x1c,%esp
80105b18:	89 d0                	mov    %edx,%eax
80105b1a:	5b                   	pop    %ebx
80105b1b:	5e                   	pop    %esi
80105b1c:	5f                   	pop    %edi
80105b1d:	5d                   	pop    %ebp
80105b1e:	c3                   	ret    
80105b1f:	90                   	nop
80105b20:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80105b23:	8b 5d e0             	mov    -0x20(%ebp),%ebx
    addr = find_free_mmap_space(p, length); // If addr is invalid, dynamically find a space
80105b26:	89 5d 0c             	mov    %ebx,0xc(%ebp)
80105b29:	89 7d 08             	mov    %edi,0x8(%ebp)
}
80105b2c:	83 c4 1c             	add    $0x1c,%esp
80105b2f:	5b                   	pop    %ebx
80105b30:	5e                   	pop    %esi
80105b31:	5f                   	pop    %edi
80105b32:	5d                   	pop    %ebp
    addr = find_free_mmap_space(p, length); // If addr is invalid, dynamically find a space
80105b33:	e9 68 fe ff ff       	jmp    801059a0 <find_free_mmap_space>
...
80105b45:	8d 45 d8             	lea    -0x28(%ebp),%eax
{
80105b48:	53                   	push   %ebx
80105b49:	83 ec 34             	sub    $0x34,%esp
  if (argint(0, &int_addr) < 0)
80105b4c:	50                   	push   %eax
80105b4d:	6a 00                	push   $0x0
80105b4f:	e8 1c ee ff ff       	call   80104970 <argint>
80105b54:	83 c4 10             	add    $0x10,%esp
80105b57:	85 c0                	test   %eax,%eax
80105b59:	0f 88 c9 00 00 00    	js     80105c28 <wmap+0xe8>
  if (argint(1, &length) < 0)
80105b5f:	83 ec 08             	sub    $0x8,%esp
80105b62:	8d 45 dc             	lea    -0x24(%ebp),%eax
  addr = (uint)int_addr;
80105b65:	8b 5d d8             	mov    -0x28(%ebp),%ebx
  if (argint(1, &length) < 0)
80105b68:	50                   	push   %eax
80105b69:	6a 01                	push   $0x1
80105b6b:	e8 00 ee ff ff       	call   80104970 <argint>
80105b70:	83 c4 10             	add    $0x10,%esp
80105b73:	85 c0                	test   %eax,%eax
80105b75:	0f 88 ad 00 00 00    	js     80105c28 <wmap+0xe8>
  if (argint(2, &flags) < 0)
80105b7b:	83 ec 08             	sub    $0x8,%esp
80105b7e:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105b81:	50                   	push   %eax
80105b82:	6a 02                	push   $0x2
80105b84:	e8 e7 ed ff ff       	call   80104970 <argint>
80105b89:	83 c4 10             	add    $0x10,%esp
80105b8c:	85 c0                	test   %eax,%eax
80105b8e:	0f 88 94 00 00 00    	js     80105c28 <wmap+0xe8>
  if (argint(3, &fd) < 0)
80105b94:	83 ec 08             	sub    $0x8,%esp
80105b97:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105b9a:	50                   	push   %eax
80105b9b:	6a 03                	push   $0x3
80105b9d:	e8 ce ed ff ff       	call   80104970 <argint>
80105ba2:	83 c4 10             	add    $0x10,%esp
80105ba5:	85 c0                	test   %eax,%eax
80105ba7:	78 7f                	js     80105c28 <wmap+0xe8>
  if (length <= 0 || (addr % PGSIZE != 0))
80105ba9:	8b 7d dc             	mov    -0x24(%ebp),%edi
80105bac:	85 ff                	test   %edi,%edi
80105bae:	7e 78                	jle    80105c28 <wmap+0xe8>
80105bb0:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
80105bb6:	75 70                	jne    80105c28 <wmap+0xe8>
  if (!(flags & MAP_FIXED))
80105bb8:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105bbb:	83 e0 0a             	and    $0xa,%eax
80105bbe:	83 f8 0a             	cmp    $0xa,%eax
80105bc1:	75 65                	jne    80105c28 <wmap+0xe8>
  struct proc *p = myproc();
80105bc3:	e8 f8 dd ff ff       	call   801039c0 <myproc>
80105bc8:	89 c2                	mov    %eax,%edx
  if (flags & MAP_FIXED)
80105bca:	f6 45 e0 08          	testb  $0x8,-0x20(%ebp)
80105bce:	74 70                	je     80105c40 <wmap+0x100>
    int result = check_fixed(*p, addr, length);
80105bd0:	83 ec 04             	sub    $0x4,%esp
80105bd3:	ff 75 dc             	push   -0x24(%ebp)
80105bd6:	89 c6                	mov    %eax,%esi
80105bd8:	b9 b1 00 00 00       	mov    $0xb1,%ecx
80105bdd:	53                   	push   %ebx
80105bde:	89 45 d4             	mov    %eax,-0x2c(%ebp)
80105be1:	81 ec c4 02 00 00    	sub    $0x2c4,%esp
80105be7:	89 e7                	mov    %esp,%edi
80105be9:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
80105beb:	e8 30 fe ff ff       	call   80105a20 <check_fixed>
80105bf0:	81 c4 d0 02 00 00    	add    $0x2d0,%esp
    if (result == FAILED)
80105bf6:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80105bf9:	83 f8 ff             	cmp    $0xffffffff,%eax
80105bfc:	74 2a                	je     80105c28 <wmap+0xe8>
  for (int i = 0; i < MAX_MMAPS; i++)
80105bfe:	8d 8a 88 00 00 00    	lea    0x88(%edx),%ecx
...
80105c10:	8b 31                	mov    (%ecx),%esi
80105c12:	85 f6                	test   %esi,%esi
80105c14:	74 6a                	je     80105c80 <wmap+0x140>
  for (int i = 0; i < MAX_MMAPS; i++)
80105c16:	83 c0 01             	add    $0x1,%eax
80105c19:	83 c1 18             	add    $0x18,%ecx
80105c1c:	83 f8 10             	cmp    $0x10,%eax
80105c1f:	75 ef                	jne    80105c10 <wmap+0xd0>
80105c21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return FAILED; // Failed fetching value to integer
80105c28:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80105c43:	85 db                	test   %ebx,%ebx
80105c45:	74 21                	je     80105c68 <wmap+0x128>
    addr = suggestive_address(p, addr, length);
80105c47:	83 ec 04             	sub    $0x4,%esp
80105c4a:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105c4d:	50                   	push   %eax
80105c4e:	53                   	push   %ebx
80105c4f:	52                   	push   %edx
80105c50:	e8 5b fe ff ff       	call   80105ab0 <suggestive_address>
80105c55:	83 c4 10             	add    $0x10,%esp
    if (addr == 0)
80105c58:	85 c0                	test   %eax,%eax
80105c5a:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    addr = suggestive_address(p, addr, length);
80105c5d:	89 c3                	mov    %eax,%ebx
    if (addr == 0)
80105c5f:	75 9d                	jne    80105bfe <wmap+0xbe>
80105c61:	eb c5                	jmp    80105c28 <wmap+0xe8>
...
80105c6b:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105c6e:	50                   	push   %eax
80105c6f:	52                   	push   %edx
80105c70:	e8 2b fd ff ff       	call   801059a0 <find_free_mmap_space>
80105c75:	eb de                	jmp    80105c55 <wmap+0x115>
80105c77:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105c7e:	66 90                	xchg   %ax,%ax
      p->mmap[i].addr = addr;
80105c80:	8d 04 40             	lea    (%eax,%eax,2),%eax
      cprintf("length of current mmap addition: %d\n", length);
80105c83:	83 ec 08             	sub    $0x8,%esp
      p->mmap[i].addr = addr;
80105c86:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105c89:	8d 34 c2             	lea    (%edx,%eax,8),%esi
      p->mmap[i].length = length;
80105c8c:	8b 45 dc             	mov    -0x24(%ebp),%eax
      p->mmap[i].addr = addr;
80105c8f:	89 5e 7c             	mov    %ebx,0x7c(%esi)
      p->mmap[i].length = length;
80105c92:	89 86 80 00 00 00    	mov    %eax,0x80(%esi)
      cprintf("length of current mmap addition: %d\n", length);
80105c98:	50                   	push   %eax
80105c99:	68 40 80 10 80       	push   $0x80108040
80105c9e:	e8 fd a9 ff ff       	call   801006a0 <cprintf>
      p->mmap[i].flags = flags;
80105ca3:	8b 45 e0             	mov    -0x20(%ebp),%eax
      p->total_mmaps++;
80105ca6:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      return addr; // return the current add
80105ca9:	83 c4 10             	add    $0x10,%esp
      p->mmap[i].used = 1;
80105cac:	c7 86 88 00 00 00 01 	movl   $0x1,0x88(%esi)
80105cb3:	00 00 00 
      p->mmap[i].flags = flags;
80105cb6:	89 86 84 00 00 00    	mov    %eax,0x84(%esi)
      p->mmap[i].fd = fd; // Store the file descriptor for file-backed mapping
80105cbc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105cbf:	89 86 8c 00 00 00    	mov    %eax,0x8c(%esi)
      p->total_mmaps++;
80105cc5:	83 82 c0 02 00 00 01 	addl   $0x1,0x2c0(%edx)
      return addr; // return the current add
80105ccc:	e9 5c ff ff ff       	jmp    80105c2d <wmap+0xed>
...
80105cd2:	06                   	push   %es
  pushl %fs
80105cd3:	0f a0                	push   %fs
  pushl %gs
80105cd5:	0f a8                	push   %gs
  pushal
80105cd7:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105cd8:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105cdc:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105cde:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105ce0:	54                   	push   %esp
  call trap
80105ce1:	e8 ca 00 00 00       	call   80105db0 <trap>
  addl $4, %esp
80105ce6:	83 c4 04             	add    $0x4,%esp
...
80105ce9:	61                   	popa   
  popl %gs
80105cea:	0f a9                	pop    %gs
  popl %fs
80105cec:	0f a1                	pop    %fs
  popl %es
80105cee:	07                   	pop    %es
  popl %ds
80105cef:	1f                   	pop    %ds
...
80105d10:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105d17:	c7 04 c5 c2 de 11 80 	movl   $0x8e000008,-0x7fee213e(,%eax,8)
80105d1e:	08 00 00 8e 
80105d22:	66 89 14 c5 c0 de 11 	mov    %dx,-0x7fee2140(,%eax,8)
80105d29:	80 
80105d2a:	c1 ea 10             	shr    $0x10,%edx
80105d2d:	66 89 14 c5 c6 de 11 	mov    %dx,-0x7fee213a(,%eax,8)
80105d34:	80 
  for (i = 0; i < 256; i++)
...
80105d3f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105d42:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105d47:	c7 05 c2 e0 11 80 08 	movl   $0xef000008,0x8011e0c2
80105d4e:	00 00 ef 
  initlock(&tickslock, "time");
80105d51:	68 65 80 10 80       	push   $0x80108065
80105d56:	68 80 de 11 80       	push   $0x8011de80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105d5b:	66 a3 c0 e0 11 80    	mov    %ax,0x8011e0c0
80105d61:	c1 e8 10             	shr    $0x10,%eax
80105d64:	66 a3 c6 e0 11 80    	mov    %ax,0x8011e0c6
  initlock(&tickslock, "time");
80105d6a:	e8 b1 e6 ff ff       	call   80104420 <initlock>
}
80105d6f:	83 c4 10             	add    $0x10,%esp
80105d72:	c9                   	leave  
80105d73:	c3                   	ret    
80105d74:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80105d8b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105d8f:	b8 c0 de 11 80       	mov    $0x8011dec0,%eax
...
80105dc2:	0f 84 60 01 00 00    	je     80105f28 <trap+0x178>
    if (myproc()->killed)
      exit();
    return;
  }
  ...
  switch (tf->trapno)
80105dc8:	83 e8 0e             	sub    $0xe,%eax
80105dcb:	83 f8 31             	cmp    $0x31,%eax
80105dce:	0f 87 b4 00 00 00    	ja     80105e88 <trap+0xd8>
80105dd4:	ff 24 85 d0 81 10 80 	jmp    *-0x7fef7e30(,%eax,4)
80105ddb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105ddf:	90                   	nop
  {
  case T_IRQ0 + IRQ_TIMER:
    if (cpuid() == 0)
80105de0:	e8 bb db ff ff       	call   801039a0 <cpuid>
80105de5:	85 c0                	test   %eax,%eax
80105de7:	0f 84 93 02 00 00    	je     80106080 <trap+0x2d0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105ded:	e8 1e cb ff ff       	call   80102910 <lapiceoi>
  }
...
80105df9:	74 1d                	je     80105e18 <trap+0x68>
80105dfb:	e8 c0 db ff ff       	call   801039c0 <myproc>
80105e00:	8b 50 24             	mov    0x24(%eax),%edx
80105e03:	85 d2                	test   %edx,%edx
80105e05:	74 11                	je     80105e18 <trap+0x68>
80105e07:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105e0b:	83 e0 03             	and    $0x3,%eax
80105e0e:	66 83 f8 03          	cmp    $0x3,%ax
80105e12:	0f 84 48 02 00 00    	je     80106060 <trap+0x2b0>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if (myproc() && myproc()->state == RUNNING &&
80105e18:	e8 a3 db ff ff       	call   801039c0 <myproc>
80105e1d:	85 c0                	test   %eax,%eax
80105e1f:	74 0f                	je     80105e30 <trap+0x80>
80105e21:	e8 9a db ff ff       	call   801039c0 <myproc>
80105e26:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105e2a:	0f 84 e0 00 00 00    	je     80105f10 <trap+0x160>
      tf->trapno == T_IRQ0 + IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105e30:	e8 8b db ff ff       	call   801039c0 <myproc>
80105e35:	85 c0                	test   %eax,%eax
80105e37:	74 1d                	je     80105e56 <trap+0xa6>
80105e39:	e8 82 db ff ff       	call   801039c0 <myproc>
80105e3e:	8b 40 24             	mov    0x24(%eax),%eax
80105e41:	85 c0                	test   %eax,%eax
80105e43:	74 11                	je     80105e56 <trap+0xa6>
80105e45:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105e49:	83 e0 03             	and    $0x3,%eax
80105e4c:	66 83 f8 03          	cmp    $0x3,%ax
80105e50:	0f 84 ff 00 00 00    	je     80105f55 <trap+0x1a5>
    exit();
}
...
80105e61:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80105e64:	68 e0 80 10 80       	push   $0x801080e0
            cprintf("File read failed for mmap region\n");
80105e69:	e8 32 a8 ff ff       	call   801006a0 <cprintf>
            kfree(mem);
80105e6e:	89 3c 24             	mov    %edi,(%esp)
80105e71:	e8 4a c6 ff ff       	call   801024c0 <kfree>
            p->killed = 1;
80105e76:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105e79:	83 c4 10             	add    $0x10,%esp
80105e7c:	c7 42 24 01 00 00 00 	movl   $0x1,0x24(%edx)
    if (!found)
80105e83:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105e87:	90                   	nop
    if (myproc() == 0 || (tf->cs & 3) == 0)
80105e88:	e8 33 db ff ff       	call   801039c0 <myproc>
80105e8d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105e90:	85 c0                	test   %eax,%eax
80105e92:	0f 84 4d 03 00 00    	je     801061e5 <trap+0x435>
80105e98:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105e9c:	0f 84 43 03 00 00    	je     801061e5 <trap+0x435>
...
80105ea2:	0f 20 d1             	mov    %cr2,%ecx
80105ea5:	89 4d d8             	mov    %ecx,-0x28(%ebp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ea8:	e8 f3 da ff ff       	call   801039a0 <cpuid>
80105ead:	8b 73 30             	mov    0x30(%ebx),%esi
80105eb0:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105eb3:	8b 43 34             	mov    0x34(%ebx),%eax
80105eb6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105eb9:	e8 02 db ff ff       	call   801039c0 <myproc>
80105ebe:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ec1:	e8 fa da ff ff       	call   801039c0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ec6:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105ec9:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105ecc:	51                   	push   %ecx
80105ecd:	57                   	push   %edi
80105ece:	52                   	push   %edx
80105ecf:	ff 75 e4             	push   -0x1c(%ebp)
80105ed2:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105ed3:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105ed6:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ed9:	56                   	push   %esi
80105eda:	ff 70 10             	push   0x10(%eax)
80105edd:	68 8c 81 10 80       	push   $0x8010818c
80105ee2:	e8 b9 a7 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105ee7:	83 c4 20             	add    $0x20,%esp
80105eea:	e8 d1 da ff ff       	call   801039c0 <myproc>
80105eef:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105ef6:	e8 c5 da ff ff       	call   801039c0 <myproc>
80105efb:	85 c0                	test   %eax,%eax
80105efd:	0f 85 f8 fe ff ff    	jne    80105dfb <trap+0x4b>
80105f03:	e9 10 ff ff ff       	jmp    80105e18 <trap+0x68>
80105f08:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105f0f:	90                   	nop
  if (myproc() && myproc()->state == RUNNING &&
80105f10:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105f14:	0f 85 16 ff ff ff    	jne    80105e30 <trap+0x80>
    yield();
80105f1a:	e8 21 e1 ff ff       	call   80104040 <yield>
80105f1f:	e9 0c ff ff ff       	jmp    80105e30 <trap+0x80>
80105f24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (myproc()->killed)
80105f28:	e8 93 da ff ff       	call   801039c0 <myproc>
80105f2d:	8b 40 24             	mov    0x24(%eax),%eax
80105f30:	85 c0                	test   %eax,%eax
80105f32:	0f 85 38 01 00 00    	jne    80106070 <trap+0x2c0>
    myproc()->tf = tf;
80105f38:	e8 83 da ff ff       	call   801039c0 <myproc>
80105f3d:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105f40:	e8 6b eb ff ff       	call   80104ab0 <syscall>
    if (myproc()->killed)
80105f45:	e8 76 da ff ff       	call   801039c0 <myproc>
80105f4a:	8b 40 24             	mov    0x24(%eax),%eax
80105f4d:	85 c0                	test   %eax,%eax
80105f4f:	0f 84 01 ff ff ff    	je     80105e56 <trap+0xa6>
}
...
80105f5b:	5d                   	pop    %ebp
      exit();
80105f5c:	e9 7f de ff ff       	jmp    80103de0 <exit>
80105f61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105f68:	8b 7b 38             	mov    0x38(%ebx),%edi
80105f6b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105f6f:	e8 2c da ff ff       	call   801039a0 <cpuid>
80105f74:	57                   	push   %edi
80105f75:	56                   	push   %esi
80105f76:	50                   	push   %eax
80105f77:	68 70 80 10 80       	push   $0x80108070
80105f7c:	e8 1f a7 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105f81:	e8 8a c9 ff ff       	call   80102910 <lapiceoi>
    break;
80105f86:	83 c4 10             	add    $0x10,%esp
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105f89:	e8 32 da ff ff       	call   801039c0 <myproc>
80105f8e:	85 c0                	test   %eax,%eax
80105f90:	0f 85 65 fe ff ff    	jne    80105dfb <trap+0x4b>
80105f96:	e9 7d fe ff ff       	jmp    80105e18 <trap+0x68>
...
80105fa5:	e8 66 c9 ff ff       	call   80102910 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105faa:	e8 11 da ff ff       	call   801039c0 <myproc>
80105faf:	85 c0                	test   %eax,%eax
80105fb1:	0f 85 44 fe ff ff    	jne    80105dfb <trap+0x4b>
80105fb7:	e9 5c fe ff ff       	jmp    80105e18 <trap+0x68>
80105fbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105fc0:	e8 cb 03 00 00       	call   80106390 <uartintr>
    lapiceoi();
80105fc5:	e8 46 c9 ff ff       	call   80102910 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105fca:	e8 f1 d9 ff ff       	call   801039c0 <myproc>
80105fcf:	85 c0                	test   %eax,%eax
80105fd1:	0f 85 24 fe ff ff    	jne    80105dfb <trap+0x4b>
80105fd7:	e9 3c fe ff ff       	jmp    80105e18 <trap+0x68>
80105fdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105fe0:	e8 5b c2 ff ff       	call   80102240 <ideintr>
80105fe5:	e9 03 fe ff ff       	jmp    80105ded <trap+0x3d>
80105fea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105ff0:	0f 20 d1             	mov    %cr2,%ecx
80105ff3:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    struct proc *p = myproc();
80105ff6:	e8 c5 d9 ff ff       	call   801039c0 <myproc>
    if (p == 0)
80105ffb:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105ffe:	85 c0                	test   %eax,%eax
    struct proc *p = myproc();
80106000:	89 c2                	mov    %eax,%edx
    if (p == 0)
80106002:	0f 84 05 02 00 00    	je     8010620d <trap+0x45d>
80106008:	8d 40 7c             	lea    0x7c(%eax),%eax
    for (int i = 0; i < MAX_MMAPS; i++)
8010600b:	31 f6                	xor    %esi,%esi
8010600d:	8d 76 00             	lea    0x0(%esi),%esi
      if (mmap->used &&
80106010:	8b 78 0c             	mov    0xc(%eax),%edi
80106013:	85 ff                	test   %edi,%edi
80106015:	74 11                	je     80106028 <trap+0x278>
          fault_addr >= mmap->addr &&
80106017:	8b 38                	mov    (%eax),%edi
      if (mmap->used &&
80106019:	39 cf                	cmp    %ecx,%edi
8010601b:	77 0b                	ja     80106028 <trap+0x278>
          fault_addr < mmap->addr + mmap->length)
8010601d:	03 78 04             	add    0x4(%eax),%edi
          fault_addr >= mmap->addr &&
80106020:	39 cf                	cmp    %ecx,%edi
80106022:	0f 87 90 00 00 00    	ja     801060b8 <trap+0x308>
    for (int i = 0; i < MAX_MMAPS; i++)
80106028:	83 c6 01             	add    $0x1,%esi
8010602b:	83 c0 18             	add    $0x18,%eax
8010602e:	83 fe 10             	cmp    $0x10,%esi
80106031:	75 dd                	jne    80106010 <trap+0x260>
      cprintf("Segmentation Fault: Fault address 0x%x\n", fault_addr);
80106033:	83 ec 08             	sub    $0x8,%esp
80106036:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106039:	51                   	push   %ecx
8010603a:	68 30 81 10 80       	push   $0x80108130
8010603f:	e8 5c a6 ff ff       	call   801006a0 <cprintf>
      p->killed = 1; // Mark the process for termination
80106044:	8b 55 e4             	mov    -0x1c(%ebp),%edx
      break;
80106047:	83 c4 10             	add    $0x10,%esp
      p->killed = 1; // Mark the process for termination
8010604a:	c7 42 24 01 00 00 00 	movl   $0x1,0x24(%edx)
      break;
80106051:	e9 9c fd ff ff       	jmp    80105df2 <trap+0x42>
80106056:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010605d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80106060:	e8 7b dd ff ff       	call   80103de0 <exit>
80106065:	e9 ae fd ff ff       	jmp    80105e18 <trap+0x68>
8010606a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106070:	e8 6b dd ff ff       	call   80103de0 <exit>
80106075:	e9 be fe ff ff       	jmp    80105f38 <trap+0x188>
8010607a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80106080:	83 ec 0c             	sub    $0xc,%esp
80106083:	68 80 de 11 80       	push   $0x8011de80
80106088:	e8 63 e5 ff ff       	call   801045f0 <acquire>
      wakeup(&ticks);
8010608d:	c7 04 24 60 de 11 80 	movl   $0x8011de60,(%esp)
      ticks++;
80106094:	83 05 60 de 11 80 01 	addl   $0x1,0x8011de60
      wakeup(&ticks);
8010609b:	e8 b0 e0 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
801060a0:	c7 04 24 80 de 11 80 	movl   $0x8011de80,(%esp)
801060a7:	e8 e4 e4 ff ff       	call   80104590 <release>
801060ac:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
801060af:	e9 39 fd ff ff       	jmp    80105ded <trap+0x3d>
801060b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        char *mem = kalloc();
801060b8:	89 55 e0             	mov    %edx,-0x20(%ebp)
801060bb:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
801060be:	e8 bd c5 ff ff       	call   80102680 <kalloc>
        if (mem == 0)
801060c3:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801060c6:	8b 55 e0             	mov    -0x20(%ebp),%edx
801060c9:	85 c0                	test   %eax,%eax
        char *mem = kalloc();
801060cb:	89 c7                	mov    %eax,%edi
        if (mem == 0)
801060cd:	0f 84 c0 00 00 00    	je     80106193 <trap+0x3e3>
        memset(mem, 0, PGSIZE);
801060d3:	83 ec 04             	sub    $0x4,%esp
        uint page_start = PGROUNDDOWN(fault_addr);
801060d6:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
801060dc:	89 55 e0             	mov    %edx,-0x20(%ebp)
        memset(mem, 0, PGSIZE);
801060df:	68 00 10 00 00       	push   $0x1000
801060e4:	6a 00                	push   $0x0
801060e6:	50                   	push   %eax
        uint page_start = PGROUNDDOWN(fault_addr);
801060e7:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
        memset(mem, 0, PGSIZE);
801060ea:	e8 c1 e5 ff ff       	call   801046b0 <memset>
        if (mappages(p->pgdir, (char *)page_start, PGSIZE, V2P(mem), PTE_W | PTE_U) < 0)
801060ef:	8b 55 e0             	mov    -0x20(%ebp),%edx
801060f2:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
801060f8:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801060ff:	50                   	push   %eax
80106100:	68 00 10 00 00       	push   $0x1000
80106105:	ff 75 e4             	push   -0x1c(%ebp)
80106108:	ff 72 04             	push   0x4(%edx)
8010610b:	e8 e0 0e 00 00       	call   80106ff0 <mappages>
80106110:	83 c4 20             	add    $0x20,%esp
80106113:	8b 55 e0             	mov    -0x20(%ebp),%edx
80106116:	85 c0                	test   %eax,%eax
80106118:	0f 88 40 fd ff ff    	js     80105e5e <trap+0xae>
        if (!(mmap->flags & MAP_ANONYMOUS))
8010611e:	8d 04 76             	lea    (%esi,%esi,2),%eax
80106121:	8d 04 c2             	lea    (%edx,%eax,8),%eax
80106124:	f6 80 84 00 00 00 04 	testb  $0x4,0x84(%eax)
8010612b:	75 48                	jne    80106175 <trap+0x3c5>
          struct file *f = p->ofile[mmap->fd]; // Get the file pointer
8010612d:	8b 88 8c 00 00 00    	mov    0x8c(%eax),%ecx
80106133:	89 55 dc             	mov    %edx,-0x24(%ebp)
          int bytes_read = fileread(f, mem, PGSIZE);
80106136:	83 ec 04             	sub    $0x4,%esp
          struct file *f = p->ofile[mmap->fd]; // Get the file pointer
80106139:	8b 4c 8a 28          	mov    0x28(%edx,%ecx,4),%ecx
          int original_offset = f->off;
8010613d:	8b 51 14             	mov    0x14(%ecx),%edx
80106140:	89 55 e0             	mov    %edx,-0x20(%ebp)
          int file_offset = page_start - mmap->addr;
80106143:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106146:	2b 50 7c             	sub    0x7c(%eax),%edx
          int bytes_read = fileread(f, mem, PGSIZE);
80106149:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
          f->off = file_offset;
8010614c:	89 51 14             	mov    %edx,0x14(%ecx)
          int bytes_read = fileread(f, mem, PGSIZE);
8010614f:	68 00 10 00 00       	push   $0x1000
80106154:	57                   	push   %edi
80106155:	51                   	push   %ecx
80106156:	e8 c5 ae ff ff       	call   80101020 <fileread>
          f->off = original_offset; // Restore the original offset
8010615b:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010615e:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
          if (bytes_read < 0)
80106161:	83 c4 10             	add    $0x10,%esp
80106164:	85 c0                	test   %eax,%eax
          f->off = original_offset; // Restore the original offset
80106166:	89 51 14             	mov    %edx,0x14(%ecx)
          if (bytes_read < 0)
80106169:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010616c:	78 47                	js     801061b5 <trap+0x405>
          if (bytes_read < PGSIZE)
8010616e:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80106173:	7e 50                	jle    801061c5 <trap+0x415>
        mmap->n_loaded_pages++;
80106175:	8d 04 76             	lea    (%esi,%esi,2),%eax
80106178:	83 84 c2 90 00 00 00 	addl   $0x1,0x90(%edx,%eax,8)
8010617f:	01 
        cprintf("r\n");
80106180:	c7 45 08 3c 80 10 80 	movl   $0x8010803c,0x8(%ebp)
}
...
8010618d:	5d                   	pop    %ebp
        cprintf("r\n");
8010618e:	e9 0d a5 ff ff       	jmp    801006a0 <cprintf>
          cprintf("Lazy allocation failed: out of memory\n");
80106193:	83 ec 0c             	sub    $0xc,%esp
80106196:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106199:	68 b8 80 10 80       	push   $0x801080b8
8010619e:	e8 fd a4 ff ff       	call   801006a0 <cprintf>
          p->killed = 1;
801061a3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801061a6:	83 c4 10             	add    $0x10,%esp
801061a9:	c7 42 24 01 00 00 00 	movl   $0x1,0x24(%edx)
    if (!found)
801061b0:	e9 d3 fc ff ff       	jmp    80105e88 <trap+0xd8>
            cprintf("File read failed for mmap region\n");
801061b5:	83 ec 0c             	sub    $0xc,%esp
801061b8:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801061bb:	68 0c 81 10 80       	push   $0x8010810c
801061c0:	e9 a4 fc ff ff       	jmp    80105e69 <trap+0xb9>
            memset(mem + bytes_read, 0, PGSIZE - bytes_read);
801061c5:	b9 00 10 00 00       	mov    $0x1000,%ecx
801061ca:	83 ec 04             	sub    $0x4,%esp
801061cd:	01 c7                	add    %eax,%edi
801061cf:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801061d2:	29 c1                	sub    %eax,%ecx
801061d4:	51                   	push   %ecx
801061d5:	6a 00                	push   $0x0
801061d7:	57                   	push   %edi
801061d8:	e8 d3 e4 ff ff       	call   801046b0 <memset>
801061dd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801061e0:	83 c4 10             	add    $0x10,%esp
801061e3:	eb 90                	jmp    80106175 <trap+0x3c5>
801061e5:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801061e8:	e8 b3 d7 ff ff       	call   801039a0 <cpuid>
801061ed:	83 ec 0c             	sub    $0xc,%esp
801061f0:	56                   	push   %esi
801061f1:	57                   	push   %edi
801061f2:	50                   	push   %eax
801061f3:	ff 73 30             	push   0x30(%ebx)
801061f6:	68 58 81 10 80       	push   $0x80108158
801061fb:	e8 a0 a4 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80106200:	83 c4 14             	add    $0x14,%esp
80106203:	68 6a 80 10 80       	push   $0x8010806a
80106208:	e8 73 a1 ff ff       	call   80100380 <panic>
      panic("trap: page fault with no process");
8010620d:	83 ec 0c             	sub    $0xc,%esp
80106210:	68 94 80 10 80       	push   $0x80108094
...
{
  if(!uart)
80106220:	a1 c0 e6 11 80       	mov    0x8011e6c0,%eax
...
801062a7:	74 78                	je     80106321 <uartinit+0xd1>
  uart = 1;
801062a9:	c7 05 c0 e6 11 80 01 	movl   $0x1,0x8011e6c0
801062b0:	00 00 00 
...
801062bc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801062bf:	bf 98 82 10 80       	mov    $0x80108298,%edi
...
801062d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
801062e0:	a1 c0 e6 11 80       	mov    0x8011e6c0,%eax
...
80106330 <uartputc>:
  if(!uart)
80106330:	a1 c0 e6 11 80       	mov    0x8011e6c0,%eax
...
801063a7:	6a 00                	push   $0x0
  jmp alltraps
801063a9:	e9 23 f9 ff ff       	jmp    80105cd1 <alltraps>
...
801063b0:	6a 01                	push   $0x1
  jmp alltraps
801063b2:	e9 1a f9 ff ff       	jmp    80105cd1 <alltraps>
...
801063b9:	6a 02                	push   $0x2
  jmp alltraps
801063bb:	e9 11 f9 ff ff       	jmp    80105cd1 <alltraps>
...
801063c2:	6a 03                	push   $0x3
  jmp alltraps
801063c4:	e9 08 f9 ff ff       	jmp    80105cd1 <alltraps>
...
801063cb:	6a 04                	push   $0x4
  jmp alltraps
801063cd:	e9 ff f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063d4:	6a 05                	push   $0x5
  jmp alltraps
801063d6:	e9 f6 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063dd:	6a 06                	push   $0x6
  jmp alltraps
801063df:	e9 ed f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063e6:	6a 07                	push   $0x7
  jmp alltraps
801063e8:	e9 e4 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063ed:	6a 08                	push   $0x8
  jmp alltraps
801063ef:	e9 dd f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063f6:	6a 09                	push   $0x9
  jmp alltraps
801063f8:	e9 d4 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801063fd:	6a 0a                	push   $0xa
  jmp alltraps
801063ff:	e9 cd f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106404:	6a 0b                	push   $0xb
  jmp alltraps
80106406:	e9 c6 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010640b:	6a 0c                	push   $0xc
  jmp alltraps
8010640d:	e9 bf f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106412:	6a 0d                	push   $0xd
  jmp alltraps
80106414:	e9 b8 f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106419:	6a 0e                	push   $0xe
  jmp alltraps
8010641b:	e9 b1 f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106422:	6a 0f                	push   $0xf
  jmp alltraps
80106424:	e9 a8 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010642b:	6a 10                	push   $0x10
  jmp alltraps
8010642d:	e9 9f f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106432:	6a 11                	push   $0x11
  jmp alltraps
80106434:	e9 98 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010643b:	6a 12                	push   $0x12
  jmp alltraps
8010643d:	e9 8f f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106444:	6a 13                	push   $0x13
  jmp alltraps
80106446:	e9 86 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010644d:	6a 14                	push   $0x14
  jmp alltraps
8010644f:	e9 7d f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106456:	6a 15                	push   $0x15
  jmp alltraps
80106458:	e9 74 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010645f:	6a 16                	push   $0x16
  jmp alltraps
80106461:	e9 6b f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106468:	6a 17                	push   $0x17
  jmp alltraps
8010646a:	e9 62 f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106471:	6a 18                	push   $0x18
  jmp alltraps
80106473:	e9 59 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010647a:	6a 19                	push   $0x19
  jmp alltraps
8010647c:	e9 50 f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106483:	6a 1a                	push   $0x1a
  jmp alltraps
80106485:	e9 47 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010648c:	6a 1b                	push   $0x1b
  jmp alltraps
8010648e:	e9 3e f8 ff ff       	jmp    80105cd1 <alltraps>
...
80106495:	6a 1c                	push   $0x1c
  jmp alltraps
80106497:	e9 35 f8 ff ff       	jmp    80105cd1 <alltraps>
...
8010649e:	6a 1d                	push   $0x1d
  jmp alltraps
801064a0:	e9 2c f8 ff ff       	jmp    80105cd1 <alltraps>
...
801064a7:	6a 1e                	push   $0x1e
  jmp alltraps
801064a9:	e9 23 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801064b0:	6a 1f                	push   $0x1f
  jmp alltraps
801064b2:	e9 1a f8 ff ff       	jmp    80105cd1 <alltraps>
...
801064b9:	6a 20                	push   $0x20
  jmp alltraps
801064bb:	e9 11 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801064c2:	6a 21                	push   $0x21
  jmp alltraps
801064c4:	e9 08 f8 ff ff       	jmp    80105cd1 <alltraps>
...
801064cb:	6a 22                	push   $0x22
  jmp alltraps
801064cd:	e9 ff f7 ff ff       	jmp    80105cd1 <alltraps>
...
801064d4:	6a 23                	push   $0x23
  jmp alltraps
801064d6:	e9 f6 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801064dd:	6a 24                	push   $0x24
  jmp alltraps
801064df:	e9 ed f7 ff ff       	jmp    80105cd1 <alltraps>
...
801064e6:	6a 25                	push   $0x25
  jmp alltraps
801064e8:	e9 e4 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801064ef:	6a 26                	push   $0x26
  jmp alltraps
801064f1:	e9 db f7 ff ff       	jmp    80105cd1 <alltraps>
...
801064f8:	6a 27                	push   $0x27
  jmp alltraps
801064fa:	e9 d2 f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106501:	6a 28                	push   $0x28
  jmp alltraps
80106503:	e9 c9 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010650a:	6a 29                	push   $0x29
  jmp alltraps
8010650c:	e9 c0 f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106513:	6a 2a                	push   $0x2a
  jmp alltraps
80106515:	e9 b7 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010651c:	6a 2b                	push   $0x2b
  jmp alltraps
8010651e:	e9 ae f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106525:	6a 2c                	push   $0x2c
  jmp alltraps
80106527:	e9 a5 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010652e:	6a 2d                	push   $0x2d
  jmp alltraps
80106530:	e9 9c f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106537:	6a 2e                	push   $0x2e
  jmp alltraps
80106539:	e9 93 f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106540:	6a 2f                	push   $0x2f
  jmp alltraps
80106542:	e9 8a f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106549:	6a 30                	push   $0x30
  jmp alltraps
8010654b:	e9 81 f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106552:	6a 31                	push   $0x31
  jmp alltraps
80106554:	e9 78 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010655b:	6a 32                	push   $0x32
  jmp alltraps
8010655d:	e9 6f f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106564:	6a 33                	push   $0x33
  jmp alltraps
80106566:	e9 66 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010656d:	6a 34                	push   $0x34
  jmp alltraps
8010656f:	e9 5d f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106576:	6a 35                	push   $0x35
  jmp alltraps
80106578:	e9 54 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010657f:	6a 36                	push   $0x36
  jmp alltraps
80106581:	e9 4b f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106588:	6a 37                	push   $0x37
  jmp alltraps
8010658a:	e9 42 f7 ff ff       	jmp    80105cd1 <alltraps>
...
80106591:	6a 38                	push   $0x38
  jmp alltraps
80106593:	e9 39 f7 ff ff       	jmp    80105cd1 <alltraps>
...
8010659a:	6a 39                	push   $0x39
  jmp alltraps
8010659c:	e9 30 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065a3:	6a 3a                	push   $0x3a
  jmp alltraps
801065a5:	e9 27 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065ac:	6a 3b                	push   $0x3b
  jmp alltraps
801065ae:	e9 1e f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065b5:	6a 3c                	push   $0x3c
  jmp alltraps
801065b7:	e9 15 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065be:	6a 3d                	push   $0x3d
  jmp alltraps
801065c0:	e9 0c f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065c7:	6a 3e                	push   $0x3e
  jmp alltraps
801065c9:	e9 03 f7 ff ff       	jmp    80105cd1 <alltraps>
...
801065d0:	6a 3f                	push   $0x3f
  jmp alltraps
801065d2:	e9 fa f6 ff ff       	jmp    80105cd1 <alltraps>
...
801065d9:	6a 40                	push   $0x40
  jmp alltraps
801065db:	e9 f1 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801065e2:	6a 41                	push   $0x41
  jmp alltraps
801065e4:	e9 e8 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801065eb:	6a 42                	push   $0x42
  jmp alltraps
801065ed:	e9 df f6 ff ff       	jmp    80105cd1 <alltraps>
...
801065f4:	6a 43                	push   $0x43
  jmp alltraps
801065f6:	e9 d6 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801065fd:	6a 44                	push   $0x44
  jmp alltraps
801065ff:	e9 cd f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106606:	6a 45                	push   $0x45
  jmp alltraps
80106608:	e9 c4 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010660f:	6a 46                	push   $0x46
  jmp alltraps
80106611:	e9 bb f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106618:	6a 47                	push   $0x47
  jmp alltraps
8010661a:	e9 b2 f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106621:	6a 48                	push   $0x48
  jmp alltraps
80106623:	e9 a9 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010662a:	6a 49                	push   $0x49
  jmp alltraps
8010662c:	e9 a0 f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106633:	6a 4a                	push   $0x4a
  jmp alltraps
80106635:	e9 97 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010663c:	6a 4b                	push   $0x4b
  jmp alltraps
8010663e:	e9 8e f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106645:	6a 4c                	push   $0x4c
  jmp alltraps
80106647:	e9 85 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010664e:	6a 4d                	push   $0x4d
  jmp alltraps
80106650:	e9 7c f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106657:	6a 4e                	push   $0x4e
  jmp alltraps
80106659:	e9 73 f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106660:	6a 4f                	push   $0x4f
  jmp alltraps
80106662:	e9 6a f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106669:	6a 50                	push   $0x50
  jmp alltraps
8010666b:	e9 61 f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106672:	6a 51                	push   $0x51
  jmp alltraps
80106674:	e9 58 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010667b:	6a 52                	push   $0x52
  jmp alltraps
8010667d:	e9 4f f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106684:	6a 53                	push   $0x53
  jmp alltraps
80106686:	e9 46 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010668d:	6a 54                	push   $0x54
  jmp alltraps
8010668f:	e9 3d f6 ff ff       	jmp    80105cd1 <alltraps>
...
80106696:	6a 55                	push   $0x55
  jmp alltraps
80106698:	e9 34 f6 ff ff       	jmp    80105cd1 <alltraps>
...
8010669f:	6a 56                	push   $0x56
  jmp alltraps
801066a1:	e9 2b f6 ff ff       	jmp    80105cd1 <alltraps>
...
801066a8:	6a 57                	push   $0x57
  jmp alltraps
801066aa:	e9 22 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801066b1:	6a 58                	push   $0x58
  jmp alltraps
801066b3:	e9 19 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801066ba:	6a 59                	push   $0x59
  jmp alltraps
801066bc:	e9 10 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801066c3:	6a 5a                	push   $0x5a
  jmp alltraps
801066c5:	e9 07 f6 ff ff       	jmp    80105cd1 <alltraps>
...
801066cc:	6a 5b                	push   $0x5b
  jmp alltraps
801066ce:	e9 fe f5 ff ff       	jmp    80105cd1 <alltraps>
...
801066d5:	6a 5c                	push   $0x5c
  jmp alltraps
801066d7:	e9 f5 f5 ff ff       	jmp    80105cd1 <alltraps>
...
801066de:	6a 5d                	push   $0x5d
  jmp alltraps
801066e0:	e9 ec f5 ff ff       	jmp    80105cd1 <alltraps>
...
801066e7:	6a 5e                	push   $0x5e
  jmp alltraps
801066e9:	e9 e3 f5 ff ff       	jmp    80105cd1 <alltraps>
...
801066f0:	6a 5f                	push   $0x5f
  jmp alltraps
801066f2:	e9 da f5 ff ff       	jmp    80105cd1 <alltraps>
...
801066f9:	6a 60                	push   $0x60
  jmp alltraps
801066fb:	e9 d1 f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106702:	6a 61                	push   $0x61
  jmp alltraps
80106704:	e9 c8 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010670b:	6a 62                	push   $0x62
  jmp alltraps
8010670d:	e9 bf f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106714:	6a 63                	push   $0x63
  jmp alltraps
80106716:	e9 b6 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010671d:	6a 64                	push   $0x64
  jmp alltraps
8010671f:	e9 ad f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106726:	6a 65                	push   $0x65
  jmp alltraps
80106728:	e9 a4 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010672f:	6a 66                	push   $0x66
  jmp alltraps
80106731:	e9 9b f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106738:	6a 67                	push   $0x67
  jmp alltraps
8010673a:	e9 92 f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106741:	6a 68                	push   $0x68
  jmp alltraps
80106743:	e9 89 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010674a:	6a 69                	push   $0x69
  jmp alltraps
8010674c:	e9 80 f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106753:	6a 6a                	push   $0x6a
  jmp alltraps
80106755:	e9 77 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010675c:	6a 6b                	push   $0x6b
  jmp alltraps
8010675e:	e9 6e f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106765:	6a 6c                	push   $0x6c
  jmp alltraps
80106767:	e9 65 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010676e:	6a 6d                	push   $0x6d
  jmp alltraps
80106770:	e9 5c f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106777:	6a 6e                	push   $0x6e
  jmp alltraps
80106779:	e9 53 f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106780:	6a 6f                	push   $0x6f
  jmp alltraps
80106782:	e9 4a f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106789:	6a 70                	push   $0x70
  jmp alltraps
8010678b:	e9 41 f5 ff ff       	jmp    80105cd1 <alltraps>
...
80106792:	6a 71                	push   $0x71
  jmp alltraps
80106794:	e9 38 f5 ff ff       	jmp    80105cd1 <alltraps>
...
8010679b:	6a 72                	push   $0x72
  jmp alltraps
8010679d:	e9 2f f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067a4:	6a 73                	push   $0x73
  jmp alltraps
801067a6:	e9 26 f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067ad:	6a 74                	push   $0x74
  jmp alltraps
801067af:	e9 1d f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067b6:	6a 75                	push   $0x75
  jmp alltraps
801067b8:	e9 14 f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067bf:	6a 76                	push   $0x76
  jmp alltraps
801067c1:	e9 0b f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067c8:	6a 77                	push   $0x77
  jmp alltraps
801067ca:	e9 02 f5 ff ff       	jmp    80105cd1 <alltraps>
...
801067d1:	6a 78                	push   $0x78
  jmp alltraps
801067d3:	e9 f9 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801067da:	6a 79                	push   $0x79
  jmp alltraps
801067dc:	e9 f0 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801067e3:	6a 7a                	push   $0x7a
  jmp alltraps
801067e5:	e9 e7 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801067ec:	6a 7b                	push   $0x7b
  jmp alltraps
801067ee:	e9 de f4 ff ff       	jmp    80105cd1 <alltraps>
...
801067f5:	6a 7c                	push   $0x7c
  jmp alltraps
801067f7:	e9 d5 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801067fe:	6a 7d                	push   $0x7d
  jmp alltraps
80106800:	e9 cc f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106807:	6a 7e                	push   $0x7e
  jmp alltraps
80106809:	e9 c3 f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106810:	6a 7f                	push   $0x7f
  jmp alltraps
80106812:	e9 ba f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106819:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010681e:	e9 ae f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106825:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010682a:	e9 a2 f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106831:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106836:	e9 96 f4 ff ff       	jmp    80105cd1 <alltraps>
...
8010683d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106842:	e9 8a f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106849:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010684e:	e9 7e f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106855:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010685a:	e9 72 f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106861:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106866:	e9 66 f4 ff ff       	jmp    80105cd1 <alltraps>
...
8010686d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106872:	e9 5a f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106879:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010687e:	e9 4e f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106885:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010688a:	e9 42 f4 ff ff       	jmp    80105cd1 <alltraps>
...
80106891:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106896:	e9 36 f4 ff ff       	jmp    80105cd1 <alltraps>
...
8010689d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801068a2:	e9 2a f4 ff ff       	jmp    80105cd1 <alltraps>
...
801068a9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801068ae:	e9 1e f4 ff ff       	jmp    80105cd1 <alltraps>
...
801068b5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801068ba:	e9 12 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801068c1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801068c6:	e9 06 f4 ff ff       	jmp    80105cd1 <alltraps>
...
801068cd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801068d2:	e9 fa f3 ff ff       	jmp    80105cd1 <alltraps>
...
801068d9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801068de:	e9 ee f3 ff ff       	jmp    80105cd1 <alltraps>
...
801068e5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801068ea:	e9 e2 f3 ff ff       	jmp    80105cd1 <alltraps>
...
801068f1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801068f6:	e9 d6 f3 ff ff       	jmp    80105cd1 <alltraps>
...
801068fd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106902:	e9 ca f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106909:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010690e:	e9 be f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106915:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010691a:	e9 b2 f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106921:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106926:	e9 a6 f3 ff ff       	jmp    80105cd1 <alltraps>
...
8010692d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106932:	e9 9a f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106939:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010693e:	e9 8e f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106945:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010694a:	e9 82 f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106951:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106956:	e9 76 f3 ff ff       	jmp    80105cd1 <alltraps>
...
8010695d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106962:	e9 6a f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106969:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010696e:	e9 5e f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106975:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010697a:	e9 52 f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106981:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106986:	e9 46 f3 ff ff       	jmp    80105cd1 <alltraps>
...
8010698d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106992:	e9 3a f3 ff ff       	jmp    80105cd1 <alltraps>
...
80106999:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010699e:	e9 2e f3 ff ff       	jmp    80105cd1 <alltraps>
...
801069a5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801069aa:	e9 22 f3 ff ff       	jmp    80105cd1 <alltraps>
...
801069b1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801069b6:	e9 16 f3 ff ff       	jmp    80105cd1 <alltraps>
...
801069bd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801069c2:	e9 0a f3 ff ff       	jmp    80105cd1 <alltraps>
...
801069c9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801069ce:	e9 fe f2 ff ff       	jmp    80105cd1 <alltraps>
...
801069d5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801069da:	e9 f2 f2 ff ff       	jmp    80105cd1 <alltraps>
...
801069e1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801069e6:	e9 e6 f2 ff ff       	jmp    80105cd1 <alltraps>
...
801069ed:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801069f2:	e9 da f2 ff ff       	jmp    80105cd1 <alltraps>
...
801069f9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801069fe:	e9 ce f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a05:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106a0a:	e9 c2 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a11:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106a16:	e9 b6 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a1d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106a22:	e9 aa f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a29:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106a2e:	e9 9e f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a35:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106a3a:	e9 92 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a41:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106a46:	e9 86 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a4d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106a52:	e9 7a f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a59:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106a5e:	e9 6e f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a65:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106a6a:	e9 62 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a71:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106a76:	e9 56 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a7d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106a82:	e9 4a f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a89:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106a8e:	e9 3e f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106a95:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106a9a:	e9 32 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106aa1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106aa6:	e9 26 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106aad:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106ab2:	e9 1a f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106ab9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106abe:	e9 0e f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106ac5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106aca:	e9 02 f2 ff ff       	jmp    80105cd1 <alltraps>
...
80106ad1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106ad6:	e9 f6 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106add:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106ae2:	e9 ea f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106ae9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106aee:	e9 de f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106af5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106afa:	e9 d2 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b01:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106b06:	e9 c6 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b0d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106b12:	e9 ba f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b19:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106b1e:	e9 ae f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b25:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106b2a:	e9 a2 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b31:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106b36:	e9 96 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b3d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106b42:	e9 8a f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b49:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106b4e:	e9 7e f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b55:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106b5a:	e9 72 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b61:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106b66:	e9 66 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b6d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106b72:	e9 5a f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b79:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106b7e:	e9 4e f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b85:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106b8a:	e9 42 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b91:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106b96:	e9 36 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106b9d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106ba2:	e9 2a f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106ba9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106bae:	e9 1e f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106bb5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106bba:	e9 12 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106bc1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106bc6:	e9 06 f1 ff ff       	jmp    80105cd1 <alltraps>
...
80106bcd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106bd2:	e9 fa f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106bd9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106bde:	e9 ee f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106be5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106bea:	e9 e2 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106bf1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106bf6:	e9 d6 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106bfd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106c02:	e9 ca f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c09:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106c0e:	e9 be f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c15:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106c1a:	e9 b2 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c21:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106c26:	e9 a6 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c2d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106c32:	e9 9a f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c39:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106c3e:	e9 8e f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c45:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106c4a:	e9 82 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c51:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106c56:	e9 76 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c5d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106c62:	e9 6a f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c69:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106c6e:	e9 5e f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c75:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106c7a:	e9 52 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c81:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106c86:	e9 46 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c8d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106c92:	e9 3a f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106c99:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106c9e:	e9 2e f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106ca5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106caa:	e9 22 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106cb1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106cb6:	e9 16 f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106cbd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106cc2:	e9 0a f0 ff ff       	jmp    80105cd1 <alltraps>
...
80106cc9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106cce:	e9 fe ef ff ff       	jmp    80105cd1 <alltraps>
...
80106cd5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106cda:	e9 f2 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106ce1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106ce6:	e9 e6 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106ced:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106cf2:	e9 da ef ff ff       	jmp    80105cd1 <alltraps>
...
80106cf9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106cfe:	e9 ce ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d05:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106d0a:	e9 c2 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d11:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106d16:	e9 b6 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d1d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106d22:	e9 aa ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d29:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106d2e:	e9 9e ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d35:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106d3a:	e9 92 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d41:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106d46:	e9 86 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d4d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106d52:	e9 7a ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d59:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106d5e:	e9 6e ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d65:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106d6a:	e9 62 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d71:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106d76:	e9 56 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d7d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106d82:	e9 4a ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d89:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106d8e:	e9 3e ef ff ff       	jmp    80105cd1 <alltraps>
...
80106d95:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106d9a:	e9 32 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106da1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106da6:	e9 26 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106dad:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106db2:	e9 1a ef ff ff       	jmp    80105cd1 <alltraps>
...
80106db9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106dbe:	e9 0e ef ff ff       	jmp    80105cd1 <alltraps>
...
80106dc5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106dca:	e9 02 ef ff ff       	jmp    80105cd1 <alltraps>
...
80106dd1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106dd6:	e9 f6 ee ff ff       	jmp    80105cd1 <alltraps>
...
80106ddd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106de2:	e9 ea ee ff ff       	jmp    80105cd1 <alltraps>
...
80106de9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106dee:	e9 de ee ff ff       	jmp    80105cd1 <alltraps>
...
80106df5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106dfa:	e9 d2 ee ff ff       	jmp    80105cd1 <alltraps>
...
80106e01:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106e06:	e9 c6 ee ff ff       	jmp    80105cd1 <alltraps>
...
80106e0d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106e12:	e9 ba ee ff ff       	jmp    80105cd1 <alltraps>
...
80106ebf:	68 06 7b 10 80       	push   $0x80107b06
...
80106ed3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ed6:	e8 c5 ca ff ff       	call   801039a0 <cpuid>
  pd[0] = size-1;
...
80106eea:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106ef1:	ff 00 00 
80106ef4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106efb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106efe:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106f05:	ff 00 00 
80106f08:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106f0f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f12:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106f19:	ff 00 00 
80106f1c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106f23:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f26:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106f2d:	ff 00 00 
80106f30:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106f37:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106f3a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106f69:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde = &pgdir[PDX(va)];
80106f6c:	8b 55 08             	mov    0x8(%ebp),%edx
80106f6f:	89 fe                	mov    %edi,%esi
80106f71:	c1 ee 16             	shr    $0x16,%esi
80106f74:	8d 34 b2             	lea    (%edx,%esi,4),%esi
  if(*pde & PTE_P){
80106f77:	8b 1e                	mov    (%esi),%ebx
80106f79:	f6 c3 01             	test   $0x1,%bl
80106f7c:	74 22                	je     80106fa0 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106f7e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106f84:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  return &pgtab[PTX(va)];
80106f8a:	89 f8                	mov    %edi,%eax
}
80106f8c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106f8f:	c1 e8 0a             	shr    $0xa,%eax
80106f92:	25 fc 0f 00 00       	and    $0xffc,%eax
80106f97:	01 d8                	add    %ebx,%eax
}
80106f99:	5b                   	pop    %ebx
80106f9a:	5e                   	pop    %esi
80106f9b:	5f                   	pop    %edi
...
80106fa0:	8b 45 10             	mov    0x10(%ebp),%eax
80106fa3:	85 c0                	test   %eax,%eax
80106fa5:	74 31                	je     80106fd8 <walkpgdir+0x78>
80106fa7:	e8 d4 b6 ff ff       	call   80102680 <kalloc>
80106fac:	89 c3                	mov    %eax,%ebx
80106fae:	85 c0                	test   %eax,%eax
80106fb0:	74 26                	je     80106fd8 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
80106fb2:	83 ec 04             	sub    $0x4,%esp
80106fb5:	68 00 10 00 00       	push   $0x1000
80106fba:	6a 00                	push   $0x0
80106fbc:	50                   	push   %eax
80106fbd:	e8 ee d6 ff ff       	call   801046b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106fc2:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106fc8:	83 c4 10             	add    $0x10,%esp
80106fcb:	83 c8 07             	or     $0x7,%eax
80106fce:	89 06                	mov    %eax,(%esi)
80106fd0:	eb b8                	jmp    80106f8a <walkpgdir+0x2a>
...
80106ffc:	8b 55 10             	mov    0x10(%ebp),%edx
  a = (char*)PGROUNDDOWN((uint)va);
80106fff:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107001:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80107005:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
8010700a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107010:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107013:	8b 45 14             	mov    0x14(%ebp),%eax
80107016:	29 d8                	sub    %ebx,%eax
80107018:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010701b:	eb 3a                	jmp    80107057 <mappages+0x67>
...
8010703e:	0f 85 86 00 00 00    	jne    801070ca <mappages+0xda>
    *pte = pa | perm | PTE_P;
80107044:	0b 75 18             	or     0x18(%ebp),%esi
80107047:	83 ce 01             	or     $0x1,%esi
8010704a:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010704c:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
...
80107057:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010705a:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
801070cd:	68 a0 82 10 80       	push   $0x801082a0
...
801070e0:	a1 c4 e6 11 80       	mov    0x8011e6c4,%eax
801070e5:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
801070fe:	0f 84 cb 00 00 00    	je     801071cf <switchuvm+0xdf>
  if(p->kstack == 0)
80107104:	8b 46 08             	mov    0x8(%esi),%eax
80107107:	85 c0                	test   %eax,%eax
80107109:	0f 84 da 00 00 00    	je     801071e9 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010710f:	8b 46 04             	mov    0x4(%esi),%eax
80107112:	85 c0                	test   %eax,%eax
80107114:	0f 84 c2 00 00 00    	je     801071dc <switchuvm+0xec>
  pushcli();
8010711a:	e8 81 d3 ff ff       	call   801044a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010711f:	e8 1c c8 ff ff       	call   80103940 <mycpu>
80107124:	89 c3                	mov    %eax,%ebx
80107126:	e8 15 c8 ff ff       	call   80103940 <mycpu>
8010712b:	89 c7                	mov    %eax,%edi
8010712d:	e8 0e c8 ff ff       	call   80103940 <mycpu>
80107132:	83 c7 08             	add    $0x8,%edi
80107135:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107138:	e8 03 c8 ff ff       	call   80103940 <mycpu>
8010713d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107140:	ba 67 00 00 00       	mov    $0x67,%edx
80107145:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
8010714c:	83 c0 08             	add    $0x8,%eax
8010714f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107156:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010715b:	83 c1 08             	add    $0x8,%ecx
8010715e:	c1 e8 18             	shr    $0x18,%eax
80107161:	c1 e9 10             	shr    $0x10,%ecx
80107164:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010716a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107170:	b9 99 40 00 00       	mov    $0x4099,%ecx
80107175:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010717c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80107181:	e8 ba c7 ff ff       	call   80103940 <mycpu>
80107186:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010718d:	e8 ae c7 ff ff       	call   80103940 <mycpu>
80107192:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107196:	8b 5e 08             	mov    0x8(%esi),%ebx
80107199:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010719f:	e8 9c c7 ff ff       	call   80103940 <mycpu>
801071a4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801071a7:	e8 94 c7 ff ff       	call   80103940 <mycpu>
801071ac:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
801071b0:	b8 28 00 00 00       	mov    $0x28,%eax
801071b5:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
801071b8:	8b 46 04             	mov    0x4(%esi),%eax
801071bb:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801071c0:	0f 22 d8             	mov    %eax,%cr3
}
...
80107209:	8b 75 10             	mov    0x10(%ebp),%esi
8010720c:	8b 55 08             	mov    0x8(%ebp),%edx
8010720f:	8b 7d 0c             	mov    0xc(%ebp),%edi
  if(sz >= PGSIZE)
80107212:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80107218:	77 50                	ja     8010726a <inituvm+0x6a>
8010721a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
8010721d:	e8 5e b4 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010722f:	e8 7c d4 ff ff       	call   801046b0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107234:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107237:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010723d:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80107244:	50                   	push   %eax
80107245:	68 00 10 00 00       	push   $0x1000
8010724a:	6a 00                	push   $0x0
8010724c:	52                   	push   %edx
8010724d:	e8 9e fd ff ff       	call   80106ff0 <mappages>
  memmove(mem, init, sz);
80107252:	89 75 10             	mov    %esi,0x10(%ebp)
80107255:	83 c4 20             	add    $0x20,%esp
80107258:	89 7d 0c             	mov    %edi,0xc(%ebp)
8010725b:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80107264:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107265:	e9 e6 d4 ff ff       	jmp    80104750 <memmove>
    panic("inituvm: more than a page");
8010726a:	83 ec 0c             	sub    $0xc,%esp
8010726d:	68 e5 82 10 80       	push   $0x801082e5
...
8010728c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
8010728f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80107294:	0f 85 bb 00 00 00    	jne    80107355 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
8010729a:	01 f0                	add    %esi,%eax
8010729c:	89 f3                	mov    %esi,%ebx
8010729e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
801072a1:	8b 45 14             	mov    0x14(%ebp),%eax
801072a4:	01 f0                	add    %esi,%eax
801072a6:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
801072a9:	85 f6                	test   %esi,%esi
801072ab:	0f 84 87 00 00 00    	je     80107338 <loaduvm+0xb8>
801072b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
801072b8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
801072bb:	8b 4d 08             	mov    0x8(%ebp),%ecx
801072be:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
801072c0:	89 c2                	mov    %eax,%edx
801072c2:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801072c5:	8b 14 91             	mov    (%ecx,%edx,4),%edx
801072c8:	f6 c2 01             	test   $0x1,%dl
801072cb:	75 13                	jne    801072e0 <loaduvm+0x60>
      panic("loaduvm: address should exist");
801072cd:	83 ec 0c             	sub    $0xc,%esp
801072d0:	68 ff 82 10 80       	push   $0x801082ff
801072d5:	e8 a6 90 ff ff       	call   80100380 <panic>
...
801072f7:	74 d4                	je     801072cd <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
8010731e:	e8 6d a7 ff ff       	call   80101a90 <readi>
80107323:	83 c4 10             	add    $0x10,%esp
80107326:	39 f8                	cmp    %edi,%eax
80107328:	75 1e                	jne    80107348 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
8010732a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80107330:	89 f0                	mov    %esi,%eax
80107332:	29 d8                	sub    %ebx,%eax
80107334:	39 c6                	cmp    %eax,%esi
80107336:	77 80                	ja     801072b8 <loaduvm+0x38>
}
...
80107358:	68 a0 83 10 80       	push   $0x801083a0
8010735d:	e8 1e 90 ff ff       	call   80100380 <panic>
...
8010737e:	0f 88 bc 00 00 00    	js     80107440 <allocuvm+0xd0>
  if(newsz < oldsz)
80107384:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80107387:	0f 82 a3 00 00 00    	jb     80107430 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
8010738d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107390:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80107396:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
8010739c:	39 75 10             	cmp    %esi,0x10(%ebp)
8010739f:	0f 86 8e 00 00 00    	jbe    80107433 <allocuvm+0xc3>
801073a5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801073a8:	8b 7d 08             	mov    0x8(%ebp),%edi
801073ab:	eb 43                	jmp    801073f0 <allocuvm+0x80>
...
801073bb:	e8 f0 d2 ff ff       	call   801046b0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801073c0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801073c6:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801073cd:	50                   	push   %eax
801073ce:	68 00 10 00 00       	push   $0x1000
801073d3:	56                   	push   %esi
801073d4:	57                   	push   %edi
801073d5:	e8 16 fc ff ff       	call   80106ff0 <mappages>
801073da:	83 c4 20             	add    $0x20,%esp
801073dd:	85 c0                	test   %eax,%eax
801073df:	78 6f                	js     80107450 <allocuvm+0xe0>
  for(; a < newsz; a += PGSIZE){
801073e1:	81 c6 00 10 00 00    	add    $0x1000,%esi
801073e7:	39 75 10             	cmp    %esi,0x10(%ebp)
801073ea:	0f 86 a0 00 00 00    	jbe    80107490 <allocuvm+0x120>
    mem = kalloc();
801073f0:	e8 8b b2 ff ff       	call   80102680 <kalloc>
...
801073fe:	68 1d 83 10 80       	push   $0x8010831d
80107403:	e8 98 92 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80107408:	8b 45 0c             	mov    0xc(%ebp),%eax
8010740b:	83 c4 10             	add    $0x10,%esp
8010740e:	39 45 10             	cmp    %eax,0x10(%ebp)
80107411:	74 2d                	je     80107440 <allocuvm+0xd0>
80107413:	8b 55 10             	mov    0x10(%ebp),%edx
80107416:	89 c1                	mov    %eax,%ecx
80107418:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
8010741b:	31 ff                	xor    %edi,%edi
8010741d:	e8 fe f9 ff ff       	call   80106e20 <deallocuvm.part.0>
}
...
8010742c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
80107430:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
80107433:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107436:	89 f8                	mov    %edi,%eax
80107438:	5b                   	pop    %ebx
80107439:	5e                   	pop    %esi
8010743a:	5f                   	pop    %edi
8010743b:	5d                   	pop    %ebp
...
80107453:	68 35 83 10 80       	push   $0x80108335
80107458:	e8 43 92 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
8010745d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107460:	83 c4 10             	add    $0x10,%esp
80107463:	39 45 10             	cmp    %eax,0x10(%ebp)
80107466:	74 0d                	je     80107475 <allocuvm+0x105>
80107468:	89 c1                	mov    %eax,%ecx
8010746a:	8b 55 10             	mov    0x10(%ebp),%edx
8010746d:	8b 45 08             	mov    0x8(%ebp),%eax
80107470:	e8 ab f9 ff ff       	call   80106e20 <deallocuvm.part.0>
      kfree(mem);
...
8010747b:	e8 40 b0 ff ff       	call   801024c0 <kfree>
      return 0;
...
801074b0:	5d                   	pop    %ebp
801074b1:	e9 6a f9 ff ff       	jmp    80106e20 <deallocuvm.part.0>
...
801074eb:	e8 30 f9 ff ff       	call   80106e20 <deallocuvm.part.0>
...
8010751e:	e8 9d af ff ff       	call   801024c0 <kfree>
...
80107533:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107534:	e9 87 af ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107539:	83 ec 0c             	sub    $0xc,%esp
8010753c:	68 51 83 10 80       	push   $0x80108351
...
80107570:	e8 3b d1 ff ff       	call   801046b0 <memset>
80107575:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80107578:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010757b:	8b 53 08             	mov    0x8(%ebx),%edx
8010757e:	83 ec 0c             	sub    $0xc,%esp
80107581:	ff 73 0c             	push   0xc(%ebx)
80107584:	29 c2                	sub    %eax,%edx
80107586:	50                   	push   %eax
80107587:	52                   	push   %edx
80107588:	ff 33                	push   (%ebx)
8010758a:	56                   	push   %esi
8010758b:	e8 60 fa ff ff       	call   80106ff0 <mappages>
80107590:	83 c4 20             	add    $0x20,%esp
...
801075a9:	5d                   	pop    %ebp
801075aa:	c3                   	ret    
801075ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801075af:	90                   	nop
      freevm(pgdir);
...
801075db:	a3 c4 e6 11 80       	mov    %eax,0x8011e6c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010760c:	68 62 83 10 80       	push   $0x80108362
...
80107653:	0f 84 c0 00 00 00    	je     80107719 <copyuvm+0xd9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107659:	8b 55 0c             	mov    0xc(%ebp),%edx
8010765c:	85 d2                	test   %edx,%edx
8010765e:	0f 84 b5 00 00 00    	je     80107719 <copyuvm+0xd9>
...
80107682:	68 6c 83 10 80       	push   $0x8010836c
...
801076a9:	74 d4                	je     8010767f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
801076ab:	8b 38                	mov    (%eax),%edi
801076ad:	f7 c7 01 00 00 00    	test   $0x1,%edi
801076b3:	0f 84 9b 00 00 00    	je     80107754 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801076b9:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
801076bb:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
801076c1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801076c4:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
801076ca:	e8 b1 af ff ff       	call   80102680 <kalloc>
801076cf:	89 c7                	mov    %eax,%edi
801076d1:	85 c0                	test   %eax,%eax
801076d3:	74 5f                	je     80107734 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801076d5:	83 ec 04             	sub    $0x4,%esp
801076d8:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
801076de:	68 00 10 00 00       	push   $0x1000
801076e3:	53                   	push   %ebx
801076e4:	50                   	push   %eax
801076e5:	e8 66 d0 ff ff       	call   80104750 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801076ea:	58                   	pop    %eax
801076eb:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
801076f1:	ff 75 e4             	push   -0x1c(%ebp)
801076f4:	50                   	push   %eax
801076f5:	68 00 10 00 00       	push   $0x1000
801076fa:	56                   	push   %esi
801076fb:	ff 75 e0             	push   -0x20(%ebp)
801076fe:	e8 ed f8 ff ff       	call   80106ff0 <mappages>
80107703:	83 c4 20             	add    $0x20,%esp
80107706:	85 c0                	test   %eax,%eax
80107708:	78 1e                	js     80107728 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
8010770a:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107710:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107713:	0f 87 57 ff ff ff    	ja     80107670 <copyuvm+0x30>
  return d;
...
8010772b:	57                   	push   %edi
8010772c:	e8 8f ad ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010773a:	e8 91 fd ff ff       	call   801074d0 <freevm>
  return 0;
8010773f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107757:	68 86 83 10 80       	push   $0x80108386
...
80107784:	0f 84 00 01 00 00    	je     8010788a <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107794:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107799:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
801077a0:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801077a2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801077a7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801077aa:	05 00 00 00 80       	add    $0x80000000,%eax
801077af:	83 fa 05             	cmp    $0x5,%edx
801077b2:	ba 00 00 00 00       	mov    $0x0,%edx
801077b7:	0f 45 c2             	cmovne %edx,%eax
}
801077ba:	c3                   	ret    
...
801077d6:	e9 a5 00 00 00       	jmp    80107880 <copyout+0xc0>
...
801077f2:	74 75                	je     80107869 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
801077f6:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
801077f9:	29 c3                	sub    %eax,%ebx
801077fb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107801:	39 f3                	cmp    %esi,%ebx
80107803:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107806:	29 f8                	sub    %edi,%eax
80107808:	83 ec 04             	sub    $0x4,%esp
8010780b:	01 c1                	add    %eax,%ecx
8010780d:	53                   	push   %ebx
8010780e:	52                   	push   %edx
8010780f:	51                   	push   %ecx
80107810:	e8 3b cf ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
...
80107825:	74 59                	je     80107880 <copyout+0xc0>
  if(*pde & PTE_P){
...
8010783d:	0f 84 4e 00 00 00    	je     80107891 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010785d:	83 e1 05             	and    $0x5,%ecx
80107860:	83 f9 05             	cmp    $0x5,%ecx
80107863:	0f 84 77 ff ff ff    	je     801077e0 <copyout+0x20>
  }
  return 0;
}
...
8010788a <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
8010788a:	a1 00 00 00 00       	mov    0x0,%eax
8010788f:	0f 0b                	ud2    

80107891 <copyout.cold>:
80107891:	a1 00 00 00 00       	mov    0x0,%eax
80107896:	0f 0b                	ud2    
